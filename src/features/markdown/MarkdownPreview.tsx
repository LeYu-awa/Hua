      ...
      const AlertIcon = ({ type }: { type: string }) => {
        switch (type) {
          ...
          case "warning":
            return (
              <svg viewBox="0 0 16 16" fill="currentColor">
                <path d="M6.457 1.047c.659-1.234 2.427-1.234 3.086 0l6.082 11.396A1.75 1.75 0 0 1 14.082 15H1.918a1.75 1.75 0 0 1-1.543-2.557Zm1.763 1.05a.25.25 0 0 0-.44 0L1.698 13.493a.25.25 0 0 0 .22.382h12.164a.25.25 0 0 0 .22-.382Zm.53 3.903a.75.75 0 0 1 1.48 0l-.22 3.28a.5.5 0 0 1-.992 0Z" />
