...
!(function (Live2DCubismCore) {
  ...
  Live2DCubismCore.Version = Utils;
  Utils = (function () {
    function Logging() {}
    return (
      (Logging.csmSetLogFunction = function (pointer) {
        Logging.logFunction = pointer;
        pointer = _em.addFunction(Logging.wrapLogFunction, "vi");
        _csm.setLogFunction(pointer);
      }),
      (Logging.csmGetLogFunction = function () {
        return Logging.logFunction;
      }),
      (Logging.wrapLogFunction = function (messageStr) {
        messageStr = _em.UTF8ToString(messageStr);
        Logging.logFunction(messageStr);
      }),
      Logging
    );
  })();
  Live2DCubismCore.Logging = Utils;
  Utils = (function () {
    ...
    return (
      (Moc.fromArrayBuffer = function (moc) {
        if (!moc) return null;
        moc = new Moc(moc);
  ...
  Live2DCubismCore.Model = Utils;
  var CanvasInfo = function (modelPtr) {
    var _canvasSize_data,
      _canvasSize_dataHeap,
      _canvasOrigin_data,
      _canvasOrigin_dataHeap,
      _canvasPPU_data,
      _canvasPPU_dataPtr,
      _canvasPPU_dataHeap;
    modelPtr &&
      ((_canvasPPU_data =
        (_canvasSize_data = new Float32Array(2)).length * _canvasSize_data.BYTES_PER_ELEMENT),
      (_canvasOrigin_dataHeap = _csm.malloc(_canvasPPU_data)),
      ...
      (_canvasPPU_dataPtr =
        (_canvasOrigin_data = new Float32Array(2)).length * _canvasOrigin_data.BYTES_PER_ELEMENT),
      (_canvasPPU_dataHeap = _csm.malloc(_canvasPPU_dataPtr)),
      (_canvasOrigin_dataHeap = new Uint8Array(
        _em.HEAPU8.buffer,
        _canvasPPU_dataHeap,
        _canvasPPU_dataPtr,
      )).set(new Uint8Array(_canvasOrigin_data.buffer)),
      (_canvasPPU_dataHeap =
        (_canvasPPU_data = new Float32Array(1)).length * _canvasPPU_data.BYTES_PER_ELEMENT),
      (_canvasPPU_dataPtr = _csm.malloc(_canvasPPU_dataHeap)),
      (_canvasPPU_dataHeap = new Uint8Array(
        _em.HEAPU8.buffer,
        _canvasPPU_dataPtr,
        _canvasPPU_dataHeap,
      )).set(new Uint8Array(_canvasPPU_data.buffer)),
      _csm.readCanvasInfo(
        modelPtr,
  ...
  var Parameters = function (modelPtr) {
    ...
    for (
      var _ids = new Uint32Array(_em.HEAPU32.buffer, _csm.getParameterIds(modelPtr), length), i = 0;
      i < _ids.length;
      i++
    )
  ...
  var Parts = function (modelPtr) {
    ...
    ((this.count = _csm.getPartCount(modelPtr)),
      ...
      (this.ids = new Array(length)));
    for (
      var _ids = new Uint32Array(_em.HEAPU32.buffer, _csm.getPartIds(modelPtr), length), i = 0;
      i < _ids.length;
      i++
    )
      this.ids[i] = _em.UTF8ToString(_ids[i]);
    ...
    _em_module =
      ...
      function (_em_module) {
                ...
                192 == (224 & g)
                  ...
                  : ((p = 63 & a[c++]),
                    (g =
                      224 == (240 & g)
                        ? ((15 & g) << 12) | (h << 6) | p
                        : ((7 & g) << 18) | (h << 12) | (p << 6) | (63 & a[c++])) < 65536
                      ? (f += String.fromCharCode(g))
                      : ((g -= 65536),
                        (f += String.fromCharCode(55296 | (g >> 10), 56320 | (1023 & g))))))
              : (f += String.fromCharCode(g));
          }
          return f;
        }
        ...
        ("undefined" != typeof TextDecoder && new TextDecoder("utf-16le"),
          ...
          (Aa = (buffer = b.buffer || new ArrayBuffer(Aa)).byteLength),
          fa(buffer),
          (O[1052] = 5247296));
        var ia = [],
          ja = [],
        ...
        function pa(a, c, d, f) {
          try {
            for (var g = 0, h = 0; h < d; h++) {
              for (var p = O[(c + 8 * h) >> 2], k = O[(c + (8 * h + 4)) >> 2], y = 0; y < k; y++)
                W(a, M[p + y]);
              g += k;
            }
            return ((O[f >> 2] = g), 0);
        ...
        function B(a) {
          if (String.prototype.startsWith ? a.startsWith(U) : 0 === a.indexOf(U)) {
            if (((a = a.slice(U.length)), "boolean" == typeof r && r)) {
              ...
              try {
                for (var f = ua(a), g = new Uint8Array(f.length), c = 0; c < f.length; ++c)
                  g[c] = f.charCodeAt(c);
                d = g;
              } catch (h) {
        ...
        ((Aa = (function (global, env, buffer) {
          ...
          function ea(a) {
            ...
            if (!((0 | (m = 0 | c[(500 + (a |= 0)) >> 2])) <= 0)) {
              ...
              do {
                if (
                  ((g = 0 | c[(n + ((24 * l) | 0) + 12) >> 2]),
                  (h = 0 | c[(o + (c[(n + ((24 * l) | 0) + 4) >> 2] << 2)) >> 2]),
                  (i = 0 | c[(o + (c[(n + ((24 * l) | 0) + 8) >> 2] << 2)) >> 2]),
                  (j = 0 | c[(n + ((24 * l) | 0) + 16) >> 2]),
                  (a = 0 | c[(n + ((24 * l) | 0) + 20) >> 2]),
                  (b = +f[(d + (l << 2)) >> 2]),
                  0 < (0 | g))
                ...
                a: do {
                  if (0 < (0 | n)) {
                    if ((0 | b) <= 0)
                      for (;;)
                        if (
                          (3 <= (b = 0 | c[(i + 8) >> 2]) >>> 0 && ((c[u >> 2] = b), ia(0, 784, u)),
                          r >>> 0 <= (i = (i + 48) | 0) >>> 0)
                        )
                          break a;
                    do {
                      ...
                      b: do {
                        if (0 | b)
                          switch (
                            ((n = (p + (c[(j + (c[(i + 12) >> 2] << 2)) >> 2] << 2)) | 0), 0 | b)
                          ) {
                            case 1:
                              for (
                                j = (i + 20) | 0, b = (i + 44) | 0, k = 0;
                                (f[(m = (o + (k << 2)) | 0) >> 2] =
                                  +f[m >> 2] + +f[b >> 2] * (+f[(n + (k << 2)) >> 2] * +f[j >> 2])),
                                  (0 | (k = (k + 1) | 0)) != (0 | q);
                              );
                              break;
                            case 2:
                              for (
                                j = (p + (c[(j + (c[(i + 16) >> 2] << 2)) >> 2] << 2)) | 0,
                                  k = (i + 20) | 0,
                                  l = (i + 24) | 0,
                                  b = (i + 44) | 0,
                                  m = 0;
          ...
          function ia(a, b, d) {
            ...
            ((S = (S + 272) | 0),
              (a = (g + 16) | 0),
              (f = g),
              (e = 0 | c[904]) && ((c[f >> 2] = d), bc(a, b, f), Z[1 & e](a)),
              (S = g));
          }
          function ma(b, d, e) {
            e |= 0;
            ...
            if (
              ...
              for (
                f = 0 | c[(b + 1048) >> 2], g = 0 | c[(b + 720) >> 2], i = h = 0;
                (i = ((1 << c[(f + (c[(g + (h << 2)) >> 2] << 2)) >> 2]) + i) | 0),
                  (0 | (h = (h + 1) | 0)) != (0 | j);
              );
              f = i << 2;
            } else f = 0;
            ...
            if (
              ...
              for (
                f = 0 | c[(b + 1048) >> 2], g = 0 | c[(b + 812) >> 2], i = h = 0;
                (i = ((1 << c[(f + (c[(g + (h << 2)) >> 2] << 2)) >> 2]) + i) | 0),
                  (0 | (h = (h + 1) | 0)) != (0 | j);
              );
              f = i << 2;
            ...
            if (
              ...
              for (
                f = 0 | c[(b + 1048) >> 2], g = 0 | c[(b + 1188) >> 2], i = h = 0;
                (i = ((1 << c[(f + (c[(g + (h << 2)) >> 2] << 2)) >> 2]) + i) | 0),
                  (0 | (h = (h + 1) | 0)) != (0 | j);
              );
              f = i << 2;
            ...
            if (
              ...
              if (
                ...
                for (
                  ...
                  (h = ((0 | c[(f + (g << 2)) >> 2]) + h) | 0), (0 | (g = (g + 1) | 0)) != (0 | i);
                );
                f = h << 2;
              } else f = 0;
              ((c[(d + 472) >> 2] = 48 * i),
              ...
              if (0 < (0 | (m = 0 | c[(n = (p + 20) | 0) >> 2]))) {
                ...
                do {
                  if (
                    ((b = 0 | c[(l + (j << 2)) >> 2]),
                    (h = ((g = (i + (c[(k + (j << 2)) >> 2] << 2)) | 0) + (b << 2)) | 0),
                    0 < (0 | b))
                  )
                    for (; (f = ((0 | c[g >> 2]) + f) | 0), (g = (g + 4) | 0) >>> 0 < h >>> 0; );
                } while ((0 | (j = (j + 1) | 0)) != (0 | m));
              } else f = 0;
            ...
            for (
              ...
              (g =
                ((b = (15 + (0 | c[(p = (d + (f << 2)) | 0) >> 2])) & -16) + (c[p >> 2] = g)) | 0),
                137 != (0 | (f = (f + 1) | 0));
            );
            c[e >> 2] = g;
          }
          function na(b, e, g) {
            ...
            if (
              ...
              for (
                g = 0 | c[(b + 1152) >> 2], k = (e + ((j = 0) | c[(p + 492) >> 2])) | 0;
                (k = ((c[(i + ((28 * j) | 0) + 12) >> 2] = k) + (c[(g + (j << 2)) >> 2] << 4)) | 0),
                  (0 | (j = (j + 1) | 0)) != (0 | h);
              );
            if (
              ...
              if (
                ...
                for (
                  ...
                  (c[(l + ((48 * g) | 0) + 40) >> 2] = h), (0 | (i = (g + 1) | 0)) != (0 | j);
                )
              ...
              for (
                m = (b + 948) | 0, n = (b + 952) | 0, l = (b + 1036) | 0, k = (e + i) | (o = 0);
                ;
              ) {
                if (
                  ((h = 0 | c[((0 | c[m >> 2]) + (o << 2)) >> 2]),
                  (i = ((y = 0 | c[((0 | c[n >> 2]) + (o << 2)) >> 2]) + h) | 0),
                  0 < (0 | y))
                ) {
                  for (
                    g = 0 | c[l >> 2], j = 0;
                    (j = ((0 | c[(g + (h << 2)) >> 2]) + j) | 0), (0 | (h = (h + 1) | 0)) < (0 | i);
                  );
              ...
              if (0 < (0 | h)) {
                if (
                  ...
                  for (;;) {
                    if (
                      ((c[(e + ((52 * k) | 0)) >> 2] = 0),
                      (c[(e + ((52 * k) | 0) + 4) >> 2] = c[(i = (q + (k << 2)) | 0) >> 2]),
                      (c[(e + ((52 * k) | 0) + 8) >> 2] = c[(A = (s + (k << 2)) | 0) >> 2]),
                      (f[(e + ((52 * k) | 0) + 12) >> 2] = +f[A >> 2] - +f[i >> 2]),
                      (c[(e + ((52 * k) | 0) + 16) >> 2] = c[(u + (k << 2)) >> 2]),
                      (c[(e + ((52 * k) | 0) + 44) >> 2] = c[(i = (v + (k << 2)) | 0) >> 2]),
                ...
                for (
                  ...
                  (c[(e + ((52 * k) | 0)) >> 2] = c[(l + (k << 2)) >> 2]),
                    (c[(e + ((52 * k) | 0) + 4) >> 2] = c[(j = (q + (k << 2)) | 0) >> 2]),
                    (c[(e + ((52 * k) | 0) + 8) >> 2] = c[(A = (s + (k << 2)) | 0) >> 2]),
                    (f[(e + ((52 * k) | 0) + 12) >> 2] = +f[A >> 2] - +f[j >> 2]),
                    (c[(e + ((52 * k) | 0) + 16) >> 2] = c[(u + (k << 2)) >> 2]),
                    (c[(e + ((52 * k) | 0) + 44) >> 2] = c[(j = (v + (k << 2)) | 0) >> 2]),
                    (t = +r(0.10000000149011612, +(+(0 | c[(w + (k << 2)) >> 2])))),
                    (f[(e + ((52 * k) | 0) + 20) >> 2] = t),
                    (f[(e + ((52 * k) | 0) + 24) >> 2] = 1.5 * t),
                    (A = 0 | c[(x + (k << 2)) >> 2]),
            ...
            if (
              ...
              for (
                g = 0 | c[C >> 2],
                  ...
                  j = 0 | c[(m + 1132) >> 2],
                  k = 0 | c[(m + 1032) >> 2];
                (c[(g + ((28 * (h = ((B = h) + -1) | 0)) | 0)) >> 2] = c[(i + (h << 2)) >> 2]),
                  (c[(g + ((28 * h) | 0) + 4) >> 2] = j + (c[(k + (h << 2)) >> 2] << 2)),
                  (c[(g + ((28 * h) | 0) + 8) >> 2] = 0),
                  (f[(g + ((28 * h) | 0) + 12) >> 2] = 0),
                  (c[(g + ((28 * h) | 0) + 16) >> 2] = 0),
                  (c[(g + ((28 * h) | 0) + 20) >> 2] = 1),
            ...
            if (((h = 0 | c[(l + 48) >> 2]), 0 < (0 | (c[(Z + 564) >> 2] = h)))) {
              ((n = (m + 1048) | 0), (o = (m + 1040) | 0), (m = (m + 1044) | 0));
              do {
                if (
                  ((l = h),
                  (g = 0 | c[U >> 2]),
                  (i = 0 | c[((0 | c[n >> 2]) + ((h = (h + -1) | 0) << 2)) >> 2]),
            ...
            if (((g = 0 | c[l >> 2]), 0 < (0 | (c[(e = (Z + 4) | 0) >> 2] = g)))) {
              ...
              for (
                ...
                (E =
                  0 |
                  c[
                    (o + ((36 * (0 | c[(p + ((g = ((F = g) + -1) | 0) << 2)) >> 2])) | 0) + 8) >> 2
                  ]),
                  (h = ((c[(i + (g << 2)) >> 2] = E) + h) | 0),
                  1 < (0 | F);
              );
            ...
            if (
              ...
              do {
                switch (
                  ...
                  (g = 0 | c[G >> 2]),
                  (c[(g + ((h = (h + -1) | 0) << 5)) >> 2] =
                    (0 | c[U >> 2]) + ((36 * (0 | c[((0 | c[m >> 2]) + (h << 2)) >> 2])) | 0)),
                  (c[(g + (h << 5) + 4) >> 2] = c[((0 | c[o >> 2]) + (h << 2)) >> 2]),
                  (c[(g + (h << 5) + 8) >> 2] = c[((0 | c[n >> 2]) + (h << 2)) >> 2]),
                  (F = 0 | c[((0 | c[l >> 2]) + (h << 2)) >> 2]),
                  (c[(g + (h << 5) + 12) >> 2] = F),
                  (i = 0 | c[((0 | c[p >> 2]) + (h << 2)) >> 2]),
                  (c[(g + (h << 5) + 16) >> 2] = i),
                  (c[(g + (h << 5) + 28) >> 2] = c[((0 | c[k >> 2]) + (h << 2)) >> 2]),
                  0 | F)
                ) {
                  case 0:
            ...
            if (
              ...
              if (
                ...
                for (
                  g = 0 | c[(B + 808) >> 2];
                  (c[(j + ((24 * h) | 0)) >> 2] = k + ((36 * (0 | c[(l + (h << 2)) >> 2])) | 0)),
                    (c[(j + ((24 * h) | 0) + 4) >> 2] = c[(m + (h << 2)) >> 2]),
                    (c[(j + ((24 * h) | 0) + 8) >> 2] = c[(n + (h << 2)) >> 2]),
                    (c[(j + ((24 * h) | 0) + 16) >> 2] = c[(o + (h << 2)) >> 2]),
                    (c[(j + ((24 * h) | 0) + 12) >> 2] = c[(g + (h << 2)) >> 2]),
                    0 < (0 | h);
                )
                  h = (h + -1) | 0;
              else
                for (
                  ...
                  h = (h + -1) | 0;
            if (((g = 0 | c[(z + 12) >> 2]), 0 < (0 | (c[(n = (Z + 164) | 0) >> 2] = g))))
              for (
                h = 0 | c[J >> 2],
                  j = 0 | c[U >> 2],
                  k = 0 | c[(B + 812) >> 2],
            ...
            if (p) {
              for (
                ...
                (I = 0 | c[(8 + (0 | c[(j + ((24 * (i = ((L = i) + -1) | 0)) | 0)) >> 2])) >> 2]),
                  (h = ((c[(g + (i << 2)) >> 2] = I) + h) | 0),
                  1 < (0 | L);
              );
              ((i = 0 | c[e >> 2]), (g = 0 | c[n >> 2]));
            ...
            if (((c[(Z + 72) >> 2] = h), (c[(Z + 64) >> 2] = i), 0 < (0 | g))) {
              for (
                ...
                (K = 0 | c[(8 + (0 | c[(j + ((12 * (g = ((L = g) + -1) | 0)) | 0)) >> 2])) >> 2]),
                  (h = ((c[(i + (g << 2)) >> 2] = K) + h) | 0),
                  1 < (0 | L);
              );
              g = 0 | c[n >> 2];
            ...
            if (
              ...
              for (
                ...
                (c[(g + ((20 * (m = ((O = m) + -1) | 0)) | 0)) >> 2] =
                  ...
                  (c[(g + ((20 * m) | 0) + 16) >> 2] = c[(k + (m << 2)) >> 2]),
                  (c[(g + ((20 * m) | 0) + 12) >> 2] = c[(l + (m << 2)) >> 2]),
                  1 < (0 | O);
              );
              for (
                g = 0 | c[N >> 2], i = 0;
                (N =
                  0 |
                  c[
                    (n + ((36 * (0 | c[(o + ((h = ((O = h) + -1) | 0) << 2)) >> 2])) | 0) + 8) >> 2
                  ]),
                  (i = ((c[(g + (h << 2)) >> 2] = N) + i) | 0),
                  1 < (0 | O);
              );
              if (((h = 0 | c[p >> 2]), (c[(Z + 348) >> 2] = i), 0 < (0 | (c[(Z + 340) >> 2] = h))))
                for (
                  ...
                  (f[(j + ((i = ((Q = i) + -4) | 0) << 2)) >> 2] = 1),
                    ...
                    (f[(g + (i << 2)) >> 2] = 0),
                    (f[(g + (O << 2)) >> 2] = 0),
                    !(((f[(g + (P << 2)) >> 2] = 0) | h) <= (f[(g + (Q << 2)) >> 2] = 1));
                )
                  h = (h + -1) | 0;
            } else ((c[(Z + 348) >> 2] = 0), (c[(Z + 340) >> 2] = h));
            if (((y = 0 | c[(z + 72) >> 2]), 0 < (0 | (c[(Z + 480) >> 2] = y)))) {
              ((h = 0 | c[M >> 2]),
                (g = 0 | c[(B + 1152) >> 2]),
                (i = 0 | c[(B + 1156) >> 2]),
                (j = 0 | c[(B + 1160) >> 2]),
                ...
                if (
                  ...
                  for (
                    o = 0 | c[(h + ((28 * w) | 0) + 12) >> 2],
                      ...
                      q = 0 | c[u >> 2],
                      x = 0;
                    (c[(o + (x << 4) + 4) >> 2] = c[(p + ((Q = (x + n) | 0) << 2)) >> 2]),
                      (c[(o + (x << 4)) >> 2] = c[(e + (Q << 2)) >> 2]),
                      (c[(o + (x << 4) + 8) >> 2] = c[(q + (Q << 2)) >> 2]),
                      (0 | (x = (x + 1) | (c[(o + (x << 4) + 12) >> 2] = 0))) != (0 | m);
                  );
              } while ((0 | (w = (w + 1) | 0)) != (0 | y));
            }
              ...
              if (0 < (0 | g)) {
                for (
                  ...
                  (c[(n + ((24 * (g = ((U = g) + -1) | 0)) | 0)) >> 2] =
                    o + ((36 * (0 | c[(p + (g << 2)) >> 2])) | 0)),
                    (c[(n + ((24 * g) | 0) + 4) >> 2] = c[(h + (g << 2)) >> 2]),
                    (c[(n + ((24 * g) | 0) + 8) >> 2] = c[(i + (g << 2)) >> 2]),
                    (c[(n + ((24 * g) | 0) + 12) >> 2] = c[(j + (g << 2)) >> 2]),
                    (R = 0 | c[(l + (g << 2)) >> 2]),
            ...
            do {
              if (3 < (0 | d[V >> 0])) {
                ...
                if (((g = 0 | c[(z + 120) >> 2]), 0 < (0 | (c[(Z + 572) >> 2] = g))))
                  for (
                    o = 0 | c[(Z + 576) >> 2],
                      i = 0 | c[W >> 2],
                      j = 0 | c[(B + 1112) >> 2],
                    ...
                    (c[(o + ((20 * (g = ((X = g) + -1) | 0)) | 0)) >> 2] =
                      ...
                      (c[(o + ((20 * g) | 0) + 12) >> 2] = c[(n + (g << 2)) >> 2]),
                      1 < (0 | X);
                  );
                if (((g = 0 | c[(z + 100) >> 2]), 0 < (0 | (c[(Z + 580) >> 2] = g))))
                  for (
                    i = 0 | c[(Z + 584) >> 2],
                      j = 0 | c[(B + 1056) >> 2],
                      k = 0 | c[(B + 1132) >> 2],
                      l = 0 | c[(B + 1052) >> 2],
                      m = 0 | c[(B + 1060) >> 2];
                    (c[(i + ((28 * (g = ((X = g) + -1) | 0)) | 0)) >> 2] = c[(j + (g << 2)) >> 2]),
                      (c[(i + ((28 * g) | 0) + 4) >> 2] = k + (c[(l + (g << 2)) >> 2] << 2)),
                      (c[(i + ((28 * g) | 0) + 8) >> 2] = c[(m + (g << 2)) >> 2]),
                      (c[(i + ((28 * g) | 0) + 12) >> 2] = 0),
                      (f[(i + ((28 * g) | 0) + 16) >> 2] = 0),
                      (c[(i + ((28 * g) | 0) + 20) >> 2] = 1),
                      (c[(i + ((28 * g) | 0) + 24) >> 2] = 1) < (0 | X);
                  );
                if (((g = 0 | c[(z + 104) >> 2]), 0 < (0 | (c[(Z + 588) >> 2] = g)))) {
                  ((p = (Z + 592) | 0),
                    (q = (Z + 584) | 0),
                    (o = (B + 1064) | 0),
                    (s = (B + 1068) | 0),
                  ...
                  do {
                    if (
                      ...
                      (h = 0 | c[p >> 2]),
                      (c[(h + ((48 * (g = (g + -1) | 0)) | 0)) >> 2] =
                        (0 | c[q >> 2]) + ((28 * (0 | c[((0 | c[o >> 2]) + (g << 2)) >> 2])) | 0)),
                      (c[(h + ((48 * g) | 0) + 4) >> 2] = c[((0 | c[s >> 2]) + (g << 2)) >> 2]),
                      (c[(h + ((48 * g) | 0) + 8) >> 2] = 0),
                      (c[(h + ((48 * g) | 0) + 28) >> 2] = 1),
                      (c[(h + ((48 * g) | 0) + 32) >> 2] = 1),
                      (j = 0 | c[((0 | c[m >> 2]) + (g << 2)) >> 2]),
                ...
                if (0 < (0 | (c[(Z + 596) >> 2] = g)))
                  for (
                    i = 0 | c[(Z + 600) >> 2],
                      ...
                      m = 0 | c[(b + 1088) >> 2],
                      h = g;
                    (c[(i + ((12 * (h = ((Y = h) + -1) | 0)) | 0)) >> 2] = c[(j + (h << 2)) >> 2]),
                      (c[(i + ((12 * h) | 0) + 4) >> 2] = c[(k + (h << 2)) >> 2]),
                      (c[(i + ((12 * h) | 0) + 8) >> 2] =
                        l + ((48 * (0 | c[(m + (h << 2)) >> 2])) | 0)),
                      1 < (0 | Y);
                  );
                if (((h = 0 | c[(n + 112) >> 2]), 0 < (0 | (c[(Z + 604) >> 2] = h))))
                  for (
                    i = 0 | c[(Z + 608) >> 2],
                      j = 0 | c[(b + 1096) >> 2],
                      k = 0 | c[(b + 1104) >> 2],
                      l = 0 | c[(Z + 592) >> 2],
                      g = 0 | c[(b + 1100) >> 2];
                    (c[(i + ((12 * (h = ((b = h) + -1) | 0)) | 0)) >> 2] = c[(j + (h << 2)) >> 2]),
                      (c[(i + ((12 * h) | 0) + 4) >> 2] = c[(k + (h << 2)) >> 2]),
                      (c[(i + ((12 * h) | 0) + 8) >> 2] =
                        l + ((48 * (0 | c[(g + (h << 2)) >> 2])) | 0)),
                      1 < (0 | b);
                ...
                if (
                  ...
                  break;
                if (((c[h >> 2] = i + (c[c[(g = (o + 968) | 0) >> 2] >> 2] << 2)), 1 == (0 | j)))
                  break;
                for (
                  h = 1;
                  (c[((0 | c[k >> 2]) + (h << 2)) >> 2] =
                ...
                do {
                  if (
                    ((h = 0 | c[((0 | c[y >> 2]) + (u << 2)) >> 2]),
                    (p = ((b = 0 | c[((0 | c[z >> 2]) + (u << 2)) >> 2]) + h) | 0),
                    (e = 0 | c[((0 | c[v >> 2]) + (u << 2)) >> 2]),
                    0 < (0 | b))
                  ) {
                    ((n = 0 | c[w >> 2]), (o = 0 | c[x >> 2]), (m = h), (h = 0));
                    do {
                      if (
                        ((g = 0 | c[(n + (m << 2)) >> 2]),
                        (l = ((b = 0 | c[(o + (m << 2)) >> 2]) + g) | 0),
                      ...
                      if (0 | f) {
                        ...
                        if (a >>> 0 < (g = (a + f + -4) | 0) >>> 0) {
                          ...
                          do {
                            ...
                            } while ((wc(d, e, j), xc(k, 2), (e = (e + 2) | 0), 0));
                          } while (
                            ((b = 1 | c[k >> 2]),
                            (c[k >> 2] = b),
                            (d = (d + 4) | 0) >>> 0 < g >>> 0)
                          ...
                          if ((1 == (0 | e)) & (1 == (0 | b))) {
                            ...
                            (0 | e) < 2
                              ...
                              : (zc(k, 2),
                                ...
                                zc(k, 1),
                                (b = 1 | c[k >> 2]),
                                yc((d = (d + -4) | 0), (c[k >> 2] = b), 0 | c[g >> 2], a, 1, j),
                                (e = a));
                          21 == (0 | l) &&
                            (xc(k, (a = (l = 0) | Ac(k))),
                            (b = 0 | c[k >> 2]),
          ...
          function oa(a, b) {
            var c, d;
            return 0 | ((d = +f[(a |= 0) >> 2]) < (c = +f[(b |= 0) >> 2]) ? -1 : (c < d) & 1);
          }
          function pa(b) {
            var d = 0 | a[(4 + (b |= 0)) >> 0];
          ...
          function qa(d) {
            ...
            if (4 < (255 & (e = 0 | a[(h = (d + 4) | 0) >> 0])))
              return (
                (c[g >> 2] = 4), (c[(g + 4) >> 2] = 255 & e), ia(0, 1101, g), (S = t), (s = 0) | s
              );
            if (
              (0 | a[(e = (d + 5) | 0) >> 0]
                ? (pb(h, 1),
                  ...
                  qb(0 | c[(d + 752) >> 2], 4, 0 | c[(4 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 756) >> 2], 4, 0 | c[(4 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 760) >> 2], 4, 0 | c[(4 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 764) >> 2], 4, 0 | c[(4 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 768) >> 2], 4, 0 | c[(4 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 772) >> 2], 4, 0 | c[(4 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 776) >> 2], 4, 0 | c[(4 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 780) >> 2], 4, 0 | c[(8 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 784) >> 2], 4, 0 | c[(8 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 788) >> 2], 4, 0 | c[(8 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 796) >> 2], 4, 0 | c[(8 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 800) >> 2], 4, 0 | c[(8 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 804) >> 2], 4, 0 | c[(8 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 812) >> 2], 4, 0 | c[(12 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 816) >> 2], 4, 0 | c[(12 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 820) >> 2], 4, 0 | c[(12 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 828) >> 2], 4, 0 | c[(12 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 852) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 856) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 860) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 868) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 872) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 876) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 880) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 884) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 888) >> 2], 1, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 892) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 896) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 900) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 904) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 908) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 912) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 924) >> 2], 4, 0 | c[(20 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 928) >> 2], 4, 0 | c[(20 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 932) >> 2], 4, 0 | c[(20 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 936) >> 2], 4, 0 | c[(20 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 940) >> 2], 4, 0 | c[(20 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 948) >> 2], 4, 0 | c[(20 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 952) >> 2], 4, 0 | c[(20 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 976) >> 2], 4, 0 | c[(24 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 980) >> 2], 4, 0 | c[(28 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 984) >> 2], 4, 0 | c[(28 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 988) >> 2], 4, 0 | c[(32 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 992) >> 2], 4, 0 | c[(32 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 996) >> 2], 4, 0 | c[(32 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1e3) >> 2], 4, 0 | c[(32 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1004) >> 2], 4, 0 | c[(32 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1008) >> 2], 4, 0 | c[(32 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1012) >> 2], 4, 0 | c[(32 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1016) >> 2], 4, 0 | c[(36 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1020) >> 2], 4, 0 | c[(36 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1024) >> 2], 4, 0 | c[(36 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1028) >> 2], 4, 0 | c[(40 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1040) >> 2], 4, 0 | c[(44 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1044) >> 2], 4, 0 | c[(48 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1048) >> 2], 4, 0 | c[(48 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1032) >> 2], 4, 0 | c[(52 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1036) >> 2], 4, 0 | c[(52 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1132) >> 2], 4, 0 | c[(56 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1136) >> 2], 4, 0 | c[(60 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1140) >> 2], 2, 0 | c[(64 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1144) >> 2], 4, 0 | c[(68 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1148) >> 2], 4, 0 | c[(72 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1152) >> 2], 4, 0 | c[(72 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1156) >> 2], 4, 0 | c[(72 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1160) >> 2], 4, 0 | c[(72 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1164) >> 2], 4, 0 | c[(72 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1168) >> 2], 4, 0 | c[(76 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1172) >> 2], 4, 0 | c[(76 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1176) >> 2], 4, 0 | c[(76 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1188) >> 2], 4, 0 | c[(80 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1192) >> 2], 4, 0 | c[(80 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1196) >> 2], 4, 0 | c[(80 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1200) >> 2], 4, 0 | c[(80 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1204) >> 2], 4, 0 | c[(80 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1208) >> 2], 4, 0 | c[(80 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1212) >> 2], 4, 0 | c[(80 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1216) >> 2], 4, 0 | c[(84 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1220) >> 2], 2, 0 | c[(84 + (0 | c[g >> 2])) >> 2]),
                  qb(0 | c[(d + 1224) >> 2], 4, 0 | c[(88 + (0 | c[g >> 2])) >> 2]),
                  1 < (255 & e) &&
                    (qb(0 | c[(d + 808) >> 2], 4, 0 | c[(8 + (0 | c[g >> 2])) >> 2]),
                    3 < (255 & e)) &&
                    (qb(0 | c[(d + 968) >> 2], 4, 0 | c[(20 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 972) >> 2], 4, 0 | c[(20 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 792) >> 2], 4, 0 | c[(8 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 824) >> 2], 4, 0 | c[(12 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 864) >> 2], 4, 0 | c[(16 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1228) >> 2], 4, 0 | c[(92 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1232) >> 2], 4, 0 | c[(92 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1236) >> 2], 4, 0 | c[(92 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1240) >> 2], 4, 0 | c[(96 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1244) >> 2], 4, 0 | c[(96 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1248) >> 2], 4, 0 | c[(96 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 944) >> 2], 4, 0 | c[(20 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 956) >> 2], 4, 0 | c[(20 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 960) >> 2], 4, 0 | c[(20 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1052) >> 2], 4, 0 | c[(100 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1056) >> 2], 4, 0 | c[(100 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1060) >> 2], 4, 0 | c[(100 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1064) >> 2], 4, 0 | c[(104 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1068) >> 2], 4, 0 | c[(104 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1072) >> 2], 4, 0 | c[(104 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1076) >> 2], 4, 0 | c[(104 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1080) >> 2], 4, 0 | c[(104 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1084) >> 2], 4, 0 | c[(108 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1088) >> 2], 4, 0 | c[(108 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1092) >> 2], 4, 0 | c[(108 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1096) >> 2], 4, 0 | c[(112 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1100) >> 2], 4, 0 | c[(112 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1104) >> 2], 4, 0 | c[(112 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1108) >> 2], 4, 0 | c[(116 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1112) >> 2], 4, 0 | c[(120 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1116) >> 2], 4, 0 | c[(120 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1120) >> 2], 4, 0 | c[(120 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1124) >> 2], 4, 0 | c[(124 + (0 | c[g >> 2])) >> 2]),
                    qb(0 | c[(d + 1128) >> 2], 4, 0 | c[(124 + (0 | c[g >> 2])) >> 2])))
                : (pa(d), (g = (d + 704) | 0)),
              0 | c[905] || (c[905] = 1),
              (e = 0 | c[g >> 2]),
              0 < (0 | c[e >> 2]))
            ...
            if (0 < (0 | c[(e + 16) >> 2]))
              for (
                k = (d + 848) | 0,
                  ...
                  j = (d + 844) | 0,
                  s = 0;
                (c[((0 | c[l >> 2]) + (s << 2)) >> 2] = (0 | c[k >> 2]) + (s << 6)),
                  (c[((0 | c[q >> 2]) + (s << 2)) >> 2] =
                    (0 | c[r >> 2]) + (c[((0 | c[p >> 2]) + (s << 2)) >> 2] << 2)),
                  (c[((0 | c[o >> 2]) + (s << 2)) >> 2] =
                    (0 | c[m >> 2]) + (c[((0 | c[n >> 2]) + (s << 2)) >> 2] << 1)),
                  (c[((0 | c[j >> 2]) + (s << 2)) >> 2] =
                    (0 | c[h >> 2]) + (c[((0 | c[i >> 2]) + (s << 2)) >> 2] << 2)),
                  (e = 0 | c[g >> 2]),
            ...
            if (1 & a[(20 + (0 | c[(d + 708) >> 2])) >> 0]) return ((S = t), 0 | d);
            if ((0 | (m = 0 | c[(e + 16) >> 2])) <= 0) return ((S = t), 0 | d);
            ((e = 0 | c[(d + 1140) >> 2]),
              (g = 0 | c[(d + 900) >> 2]),
              (h = 0 | c[(d + 904) >> 2]),
              (j = 0));
          ...
          function ta(a) {
            var j,
              ...
              b = (a + 144) | 0;
            if (
              (xa(e, 0 | c[(a + 88) >> 2], 0 | c[(a + 148) >> 2], 0 | c[b >> 2]),
              za(
                e,
                0 | c[(a + 92) >> 2],
                0 | c[(a + 152) >> 2],
              ...
              !(
                (0 | d[(4 + (0 | c[a >> 2])) >> 0]) < 4 ||
                (xa(e, 0 | c[(a + 96) >> 2], 0 | c[(m = (a + 120) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 100) >> 2], 0 | c[(f = (a + 124) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 104) >> 2], 0 | c[(g = (a + 128) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 108) >> 2], 0 | c[(j = (a + 132) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 112) >> 2], 0 | c[(k = (a + 136) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 116) >> 2], 0 | c[(l = (a + 140) | 0) >> 2], 0 | c[b >> 2]),
                (b = 0 | c[(a + 156) >> 2]),
                (e = 0 | c[m >> 2]),
                (f = 0 | c[f >> 2]),
                (g = 0 | c[g >> 2]),
          ...
          function ua(a) {
            var j,
              ...
              b = (a + 264) | 0;
            if (
              (xa(e, 0 | c[(a + 196) >> 2], 0 | c[(a + 268) >> 2], 0 | c[b >> 2]),
              xa(e, 0 | c[(a + 200) >> 2], 0 | c[(a + 284) >> 2], 0 | c[b >> 2]),
              xa(e, 0 | c[(a + 204) >> 2], 0 | c[(a + 276) >> 2], 0 | c[b >> 2]),
              xa(e, 0 | c[(a + 208) >> 2], 0 | c[(a + 280) >> 2], 0 | c[b >> 2]),
              xa(e, 0 | c[(a + 212) >> 2], 0 | c[(a + 272) >> 2], 0 | c[b >> 2]),
              !(
                (0 | d[(4 + (0 | c[a >> 2])) >> 0]) < 4 ||
                (xa(e, 0 | c[(a + 216) >> 2], 0 | c[(m = (a + 240) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 220) >> 2], 0 | c[(f = (a + 244) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 224) >> 2], 0 | c[(g = (a + 248) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 228) >> 2], 0 | c[(j = (a + 252) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 232) >> 2], 0 | c[(k = (a + 256) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 236) >> 2], 0 | c[(l = (a + 260) | 0) >> 2], 0 | c[b >> 2]),
                (b = 0 | c[(a + 296) >> 2]),
                (e = 0 | c[m >> 2]),
                (f = 0 | c[f >> 2]),
                (g = 0 | c[g >> 2]),
          ...
          function va(a) {
            var j,
              ...
              b = (a + 424) | 0;
            if (
              (xa(e, 0 | c[(a + 364) >> 2], 0 | c[(a + 448) >> 2], 0 | c[b >> 2]),
              ya(e, 0 | c[(a + 368) >> 2], 0 | c[(a + 440) >> 2], 0 | c[b >> 2]),
              za(
                e,
                0 | c[(a + 372) >> 2],
                0 | c[(a + 444) >> 2],
              ...
              !(
                (0 | d[(4 + (0 | c[a >> 2])) >> 0]) < 4 ||
                (xa(e, 0 | c[(a + 376) >> 2], 0 | c[(m = (a + 400) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 380) >> 2], 0 | c[(f = (a + 404) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 384) >> 2], 0 | c[(g = (a + 408) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 388) >> 2], 0 | c[(j = (a + 412) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 392) >> 2], 0 | c[(k = (a + 416) | 0) >> 2], 0 | c[b >> 2]),
                xa(e, 0 | c[(a + 396) >> 2], 0 | c[(l = (a + 420) | 0) >> 2], 0 | c[b >> 2]),
                (b = 0 | c[(a + 452) >> 2]),
                (e = 0 | c[m >> 2]),
                (f = 0 | c[f >> 2]),
                (g = 0 | c[g >> 2]),
          ...
          function xa(a, b, d, e) {
            ...
            if (0 < (0 | (g = 0 | c[(8 + (a |= 0)) >> 2])))
              for (
                ...
                (f[(i + (j << 2)) >> 2] = +f[(b + (j << 2)) >> 2] * +f[(h + (j << 2)) >> 2]),
                  (0 | (j = (j + 1) | 0)) != (0 | g);
              );
            if (!((0 | (n = 0 | c[a >> 2])) <= 0))
              if (((l = (a + 16) | 0), (o = 0 | c[(a + 4) >> 2]), (m = (a + 12) | 0), e))
                for (b = j = 0; ; ) {
                  if (0 | c[e >> 2]) {
                    if (
                      ((h = ((a = 0 | c[((0 | c[l >> 2]) + (b << 2)) >> 2]) + j) | 0), 0 < (0 | a))
                    )
                      for (
                        g = 0 | c[m >> 2], i = j, k = 0;
                        (k += +f[(g + (i << 2)) >> 2]), (0 | (i = (i + 1) | 0)) < (0 | h);
                      );
                    else k = 0;
                    f[(d + (b << 2)) >> 2] = k;
                  }
          ...
          function ya(a, b, d, e) {
            ...
            if (!((0 | (g = 0 | c[a >> 2])) <= 0))
              if (((l = (a + 16) | 0), (m = 0 | c[(a + 4) >> 2]), (n = (a + 12) | 0), e))
                for (b = j = 0; ; ) {
                  if (0 | c[e >> 2]) {
                    if (
                      ((h = ((i = 0 | c[((0 | c[l >> 2]) + (b << 2)) >> 2]) + j) | 0), 0 < (0 | i))
                    )
                      for (
                        g = 0 | c[n >> 2], i = j, k = 0;
                        (k += +f[(g + (i << 2)) >> 2]), (0 | (i = (i + 1) | 0)) < (0 | h);
                    ...
                    ((c[(d + (b << 2)) >> 2] = ~~(k + 0.0010000000474974513)), (g = 0 | c[a >> 2]));
                  }
          ...
          function za(a, b, d, e, g, h) {
            ...
            if (!((0 | (t = 0 | c[(a |= 0) >> 2])) <= 0))
              if (
                ((w = (a + 16) | 0), (u = 0 | c[(a + 4) >> 2]), (s = (a + 20) | 0), (r = g << 2), h)
              )
                for (p = o = 0; ; ) {
                  if (
                    0 | c[h >> 2] &&
          ...
          function ob(a, b, c, d) {
            ...
            if (!(3.1415927410125732 < b)) return +b;
            for (; 3.1415927410125732 < (b += -6.2831854820251465); );
            return +b;
          }
          function pb(b, c) {
            var d;
            if (!((c = ((b |= 0) + (0 | c) - 1) | 0) >>> 0 <= b >>> 0))
              for (
                ;
                (d = 0 | a[b >> 0]),
                  (a[b >> 0] = 0 | a[c >> 0]),
          ...
          function qb(b, c, d) {
            ...
            if ((d |= 0))
              do {
                if (((d = (d + -1) | 0), (f = b) >>> 0 < (e = ((b = (b + c) | 0) - 1) | 0) >>> 0))
                  for (
                    ;
                    (g = 0 | a[f >> 0]),
                      (a[f >> 0] = 0 | a[e >> 0]),
          ...
          function xb(a) {
            ...
            if (0 < (0 | n))
              for (
                n = 0 | c[p >> 2], g = 0 | c[(a + 448) >> 2], h = 0 | c[(a + 444) >> 2];
                0 | c[n >> 2] &&
                  (-1 != (0 | (e = 0 | c[(b + 4) >> 2])) &&
                  ...
                  -1 != (0 | (e = 0 | c[(b + 8) >> 2])) &&
                    ...
                    (r = 0 | c[h >> 2]),
                    $[3 & c[(k + (e << 5) + 24) >> 2]](a, e, r, r, 0 | c[(b + 16) >> 2]))),
                  !(m >>> 0 <= (b = (b + 20) | 0) >>> 0);
              )
            ...
            if (
              ...
              for (
                h = 0 | c[p >> 2], e = b, g = 0 | c[(a + 452) >> 2], b = 0 | c[(a + 456) >> 2];
                0 | c[h >> 2] &&
                  -1 != (0 | (q = 0 | c[(e + 8) >> 2])) &&
                  ((t = +f[g >> 2] * +f[(o = (i + ((p = q << 2) << 2)) | 0) >> 2]),
                  (f[g >> 2] = t),
          ...
          function yb(a) {
            var e,
              b = 0 | c[(332 + (a |= 0)) >> 2];
            0 | c[(a + 428) >> 2] &&
              (Uc(0 | c[(a + 460) >> 2], 0 | c[(a + 436) >> 2], 0 | (e = b << 2)),
              Uc(0 | c[(a + 464) >> 2], 0 | c[(a + 440) >> 2], 0 | e),
              Uc(0 | c[(a + 468) >> 2], 0 | c[(a + 448) >> 2], 0 | e),
              (0 | d[(4 + (0 | c[a >> 2])) >> 0]) <= 3 ||
                (Uc(0 | c[(a + 472) >> 2], 0 | c[(a + 452) >> 2], 0 | (e = b << 4)),
          ...
          function zb(b) {
            ...
            if (0 | c[(b + 620) >> 2]) {
              if (!(((c[d >> 2] = 0) | w) <= 0))
                for (
                  h = (b + 424) | 0, i = (b + 432) | 0, d = (b + 448) | 0, e = 0;
                  (g =
                    0 != (0 | c[((0 | c[h >> 2]) + (e << 2)) >> 2]) &&
                    0 != +f[((0 | c[d >> 2]) + (e << 2)) >> 2]
                      ? 127
                ...
                if (
                  ...
                  for (
                    ...
                    (l = 0 == (0 | c[((0 | c[m >> 2]) + (d << 2)) >> 2])),
                      ...
                      (v = ((0 | c[p >> 2]) + d) | 0),
                      (u =
                        (1 & a[v >> 0]) == ((u = (0 != x) & (1 ^ l) & 1) << 24) >> 24 ? u : 2 | u),
                      (u = x != +f[((0 | c[r >> 2]) + (d << 2)) >> 2] ? 4 | u : u),
                      (u =
                        (0 | c[((0 | c[n >> 2]) + (d << 2)) >> 2]) ==
                        (0 | c[((0 | c[q >> 2]) + (d << 2)) >> 2])
                          ? u
                  ...
                  for (
                    ...
                    (y = 0 == (0 | c[((0 | c[m >> 2]) + (g << 2)) >> 2])),
                      ...
                      (e = ((0 | c[p >> 2]) + g) | 0),
                      (d =
                        (1 & a[e >> 0]) == ((d = (0 != x) & (1 ^ y) & 1) << 24) >> 24 ? d : 2 | d),
                      (d = x != +f[((0 | c[r >> 2]) + (g << 2)) >> 2] ? 4 | d : d),
                      (d =
                        (0 | c[((0 | c[n >> 2]) + (g << 2)) >> 2]) ==
                        (0 | c[((0 | c[q >> 2]) + (g << 2)) >> 2])
                          ? d
              ...
              for (
                ...
                0 != (0 | c[((0 | c[g >> 2]) + (e << 2)) >> 2]) &&
                0 != +f[((0 | c[d >> 2]) + (e << 2)) >> 2]
                  ? ((v = ((0 | c[h >> 2]) + e) | 0), (a[v >> 0] = 1 | a[v >> 0]))
                  : ((v = ((0 | c[h >> 2]) + e) | 0), (a[v >> 0] = -2 & a[v >> 0])),
                  (0 | (e = (e + 1) | 0)) != (0 | w);
              );
          }
          function Bb(a) {
              ...
              for (
                ...
                if (
                  ...
                  15 ==
                    (0 |
                      (z =
                        0 != (0 | c[(b = (g + 24) | 0) >> 2]) || 0 | c[(g + 28) >> 2] ? 15 : z)) &&
                    ((c[(((z = 0) | c[s >> 2]) + (i << 2)) >> 2] = c[(r = (g + 12) | 0) >> 2]),
                    0 | c[b >> 2]) &&
                    ((o = 0 | c[(l + (i << 2)) >> 2]),
                    (x = ((p = 0 | c[(g + 16) >> 2]) + ((H = 0 | c[r >> 2]) << 2)) | 0),
                    0 < (0 | H)))
                )
                  for (
                    b = p,
                ...
                if (
                  0 | c[(g + 28) >> 2] &&
                  ((y = ((q = 0 | c[(g + 20) >> 2]) + ((H = 0 | c[(g + 12) >> 2]) << 2)) | 0),
                  0 < (0 | H))
                )
                  for (
                    b = ((0 | c[w >> 2]) + (j << 2)) | 0, e = q;
                    (c[b >> 2] = c[e >> 2]), !(y >>> 0 <= (e = (e + 4) | 0) >>> 0);
                  )
                    b = (b + 4) | 0;
            ...
            if (
              !(
                (0 | d[(b + 4) >> 0]) < 4 ||
                ((G = 0 | c[A >> 2]), (H = 0 | c[(b + 792) >> 2]), (0 | (A = 0 | c[B >> 2])) <= 0)
              )
            )
              for (
                D = (a + 96) | 0,
                ...
                if (
                  ...
                  0 | c[(b + 24) >> 2] &&
                    ((I = 0 | c[(H + (l << 2)) >> 2]),
                    (K = ((J = 0 | c[(b + 16) >> 2]) + ((a = 0 | c[(b + 12) >> 2]) << 2)) | 0),
                    0 < (0 | a)))
                )
                  for (
                    e = 0 | c[x >> 2],
              ...
              for (
                ...
                if (
                  ...
                  14 ==
                    (0 |
                      (P =
                        0 != (0 | c[(b = (t + 24) | 0) >> 2]) || 0 | c[(t + 28) >> 2] ? 14 : P)) &&
                    ((c[(((P = 0) | c[A >> 2]) + (N << 2)) >> 2] = c[(z = (t + 12) | 0) >> 2]),
                    0 | c[b >> 2]))
                ) {
                  if (
                    ((b = 0 | c[(r + (N << 2)) >> 2]),
                    (k = ((e = 0 | c[(t + 16) >> 2]) + ((q = 0 | c[z >> 2]) << 2)) | 0),
                    0 < (0 | q))
                  )
                    for (
                      f = 0 | c[v >> 2],
                      ...
                      ((l = (l + 4) | 0),
                        ...
                        (q = (q + 4) | 0));
                  ((W = ((0 | c[e >> 2]) + b) | 0),
                    (c[((0 | c[x >> 2]) + (N << 2)) >> 2] = c[((0 | c[H >> 2]) + (W << 2)) >> 2]),
                    (c[((0 | c[y >> 2]) + (N << 2)) >> 2] = c[((0 | c[I >> 2]) + (W << 2)) >> 2]));
                }
                if (
                  0 | c[(t + 28) >> 2] &&
                  ((M = ((u = 0 | c[(t + 20) >> 2]) + ((W = 0 | c[(t + 12) >> 2]) << 2)) | 0),
                  0 < (0 | W))
                )
                  for (
                    b = ((0 | c[L >> 2]) + (O << 2)) | 0, e = u;
                    (c[b >> 2] = c[e >> 2]), !(M >>> 0 <= (e = (e + 4) | 0) >>> 0);
                  )
                    b = (b + 4) | 0;
            ...
            if (
              ...
              for (
                ...
                if (
                  ...
                  0 | c[(j + 24) >> 2] &&
                    ((U = 0 | c[(G + (l << 2)) >> 2]),
                    (V = ((T = 0 | c[(j + 16) >> 2]) + ((W = 0 | c[(j + 12) >> 2]) << 2)) | 0),
                    0 < (0 | W)))
                )
                  for (
                    b = 0 | c[x >> 2],
          ...
          function Db(a) {
              ...
              for (
                ...
                if (
                  ...
                  15 ==
                    (0 |
                      (C =
                        0 != (0 | c[(b = (h + 24) | 0) >> 2]) || 0 | c[(h + 28) >> 2] ? 15 : C)) &&
                    ((c[(((C = 0) | c[t >> 2]) + (j << 2)) >> 2] = c[(s = (h + 12) | 0) >> 2]),
                    0 | c[b >> 2]) &&
                    ((p = 0 | c[(m + (j << 2)) >> 2]),
                    (A = ((q = 0 | c[(h + 16) >> 2]) + ((H = 0 | c[s >> 2]) << 2)) | 0),
                    0 < (0 | H)))
                )
                  for (
                    b = ((0 | c[u >> 2]) + (k << 2)) | 0,
                ...
                if (
                  0 | c[(h + 28) >> 2] &&
                  ((B = ((r = 0 | c[(h + 20) >> 2]) + ((H = 0 | c[(h + 12) >> 2]) << 2)) | 0),
                  0 < (0 | H))
                )
                  for (
                    b = ((0 | c[z >> 2]) + (k << 2)) | 0, e = r;
                    (c[b >> 2] = c[e >> 2]), !(B >>> 0 <= (e = (e + 4) | 0) >>> 0);
                  )
                    b = (b + 4) | 0;
            ...
            if (
              !(
                (0 | d[(b + 4) >> 0]) < 4 ||
                ((G = 0 | c[D >> 2]), (H = 0 | c[(b + 864) >> 2]), (0 | (A = 0 | c[E >> 2])) <= 0)
              )
            )
              for (
                D = (a + 376) | 0,
            ...
            if (
              ...
              (function (a) {
                var e,
                  ...
                  j = 0,
                  k = 0,
                  i = ((b = 0 | c[(4 + (a |= 0)) >> 2]) + ((52 * (h = 0 | c[a >> 2])) | 0)) | 0;
                if (!((0 | h) <= 0))
                  for (
                    h = 0 | c[(a + 12) >> 2];
                    (d = +f[h >> 2]),
                      (a = (b + 4) | 0),
                      (d = (g = 0 == (0 | c[(b + 16) >> 2]))
                        ? ((k = +f[a >> 2]), (j = +f[(b + 8) >> 2]), d < k ? k : j < d ? j : d)
                        : ((k = +f[(b + 12) >> 2]),
                          (j = +f[a >> 2]) + k * ((d = (d - j) / k) - (0 | ~~+q(+d))))),
                      (a = (b + 48) | 0),
                      +f[(e = (b + 44) | 0) >> 2] != d
                        ? ((c[a >> 2] = 1), (f[e >> 2] = d))
                        : (c[a >> 2] = 0),
                  ...
                  do {
                    a: do {
                      if (
                        ...
                        (q = +f[(b + 24) >> 2]),
                        (t =
                          ((r = 0 | c[(b + 28) >> 2]) + ((28 * (l = 0 | c[(b + 32) >> 2])) | 0)) |
                          0),
                        0 < (0 | l))
                      ) {
                        if (!n)
            ...
            (!(function (a, b, d) {
                  ...
                  for (
                    ...
                    if (
                      ...
                      6 ==
                        (0 |
                          (u =
                            0 != (0 | c[(a = (24 + e) | 0) >> 2]) || 0 | c[(28 + e) >> 2]
                              ? 6
                              : u)) &&
                        ((c[(((u = 0) | c[q >> 2]) + (g << 2)) >> 2] = c[(p = (12 + e) | 0) >> 2]),
                        0 | c[a >> 2]) &&
                        ((o = 0 | c[(m + (g << 2)) >> 2]),
                        (s = ((k = 0 | c[(16 + e) >> 2]) + ((d = 0 | c[p >> 2]) << 2)) | 0),
                        0 < (0 | d)))
                    )
                      for (
                        a = 0 | c[f >> 2], b = ((0 | c[r >> 2]) + (h << 2)) | 0, d = k;
                        (c[b >> 2] = c[(a + (((0 | c[d >> 2]) + o) << 2)) >> 2]),
                          !(s >>> 0 <= (d = (d + 4) | 0) >>> 0);
                      )
                        b = (b + 4) | 0;
                    if (
                      0 | c[(28 + e) >> 2] &&
                      ((t = ((l = 0 | c[(20 + e) >> 2]) + ((d = 0 | c[(12 + e) >> 2]) << 2)) | 0),
                      0 < (0 | d))
                    )
                      for (
                        a = ((0 | c[i >> 2]) + (h << 2)) | 0, b = l;
                        (c[a >> 2] = c[b >> 2]), !(t >>> 0 <= (b = (b + 4) | 0) >>> 0);
                      )
                        a = (a + 4) | 0;
              ...
              (function (a) {
                ...
                if (
                  ...
                  (j = k),
                  (i =
                    ((b = 0 | c[(308 + (a |= 0)) >> 2]) + ((e = 0 | c[(a + 304) >> 2]) << 5)) | 0),
                  (f = 0 | c[(a + 40) >> 2]),
                  (g = 0 | c[(a + 312) >> 2]),
                  (h = 0 | c[(a + 144) >> 2]),
                  (d = 0 | c[(a + 264) >> 2]),
              ...
              (function (a) {
                xa((508 + (a |= 0)) | 0, 0 | c[(532 + a) >> 2], 0 | c[(536 + a) >> 2], 0);
              })(a),
              fa(a),
              ha(a),
              (function (a) {
                var b = 0,
                  ...
                  j = 0,
                  i =
                    ((b = 0 | c[(8 + (a |= 0)) >> 2]) + ((12 * (j = 0 | c[(a + 4) >> 2])) | 0)) | 0,
                  e = 0 | c[(a + 48) >> 2];
                if (!((0 | j) <= 0))
                  for (
                    j = 0 | c[(a + 40) >> 2], d = e, a = 0 | c[(a + 52) >> 2];
                    0 | c[j >> 2] &&
                      ((g = +f[a >> 2]), (f[d >> 2] = g), -1 != (0 | (h = 0 | c[(b + 4) >> 2]))) &&
                      (f[d >> 2] = g * +f[(e + (h << 2)) >> 2]),
                      !(i >>> 0 <= (b = (b + 12) | 0) >>> 0);
                  )
              ...
              (function (a) {
                var b,
                  ...
                  e = 0,
                  f = 0;
                if (!((0 | (b = 0 | c[(304 + (a |= 0)) >> 2])) <= 0))
                  for (
                    d = 0 | c[(312 + a) >> 2], e = 0 | c[(308 + a) >> 2], f = 0;
              ...
              (function (a) {
                ...
                if (
                  !(
                    0 | c[((a |= 0) + 624) >> 2] ||
                    ((g =
                      ((b = 0 | c[(a + 336) >> 2]) + ((20 * (h = 0 | c[(a + 332) >> 2])) | 0)) | 0),
                    (0 | h) <= 0)
                  )
                )
                  for (h = 0 | c[(a + 424) >> 2], a = 0 | c[(a + 444) >> 2]; ; ) {
                    if (
                      0 | c[h >> 2] &&
                      ((e = 0 | c[a >> 2]), (i = (d = 0 | c[(b + 16) >> 2]) << 1), 0 < (0 | d))
                    )
                      for (
                        d = 1;
                        (f[(j = (e + (d << 2)) | 0) >> 2] = -+f[j >> 2]),
                      ...
                      if (0 < (0 | b))
                        for (
                          e = 0 | c[(r + ((28 * m) | 0) + 12) >> 2],
                            ...
                            f = 0 | c[l >> 2],
                            i = 0;
                          (d = ((0 | c[(e + (i << 4) + 12) >> 2]) - (0 | c[g >> 2])) | 0),
                            (b =
                              -1 == (0 | (b = 0 | c[(h = (f + (d << 2)) | 0) >> 2]))
                                ? ((0 | c[o >> 2]) + (d << 2)) | 0
                                : (j + (b << 2)) | 0),
                            (c[b >> 2] = i),
                            (0 | (i = ((c[h >> 2] = i) + 1) | 0)) < (0 | c[k >> 2]);
                        );
                    }
                    if (0 < (0 | (b = 0 | c[a >> 2]))) {
                      ((i = 0 | c[o >> 2]),
                              ...
                              ((b =
                                1 == (0 | c[(f + (e << 4)) >> 2])
                                  ? ((b = 0 | c[(f + (e << 4) + 8) >> 2]),
                                    (c[(r + ((28 * b) | 0) + 8) >> 2] = d),
                                    0 | c[(r + ((28 * b) | 0)) >> 2])
                                  : ((c[(n + (c[(f + (e << 4) + 4) >> 2] << 2)) >> 2] = d), 1)) +
                                d) |
                              0),
                              !(
                                ((0 | (e = 0 | c[(g + ((k = e) << 2)) >> 2])) <= (0 | k)) |
                                (-1 == (0 | e))
                              );
                          );
                          b = 0 | c[a >> 2];
          ...
          function Nb(a) {
            ...
            if (
              !(
                (0 | d[(4 + (0 | c[(a |= 0) >> 2])) >> 0]) < 4 ||
                ((s = ((b = 0 | c[(a + 544) >> 2]) + ((52 * (l = 0 | c[(a + 540) >> 2])) | 0)) | 0),
                (0 | l) <= 0)
              )
            ) {
              l = 0 == (0 | c[(a + 620) >> 2]);
              do {
                a: do {
                  if (
                    ...
                    ((q = +f[(b + 44) >> 2]),
                    (t =
                      ((r = 0 | c[(b + 36) >> 2]) + ((28 * (k = 0 | c[(b + 40) >> 2])) | 0)) | 0),
                    0 < (0 | k))
                  ) {
                    if (!l)
                      for (j = r; ; ) {
          ...
          function Ob(a) {
            ...
            if (
              !(
                (0 | d[(4 + (0 | c[(a |= 0) >> 2])) >> 0]) < 4 ||
                ((t = ((b = 0 | c[(a + 592) >> 2]) + ((48 * (s = 0 | c[(a + 588) >> 2])) | 0)) | 0),
                (0 | s) <= 0)
              )
            ) {
              s = 0 == (0 | c[(a + 620) >> 2]);
              do {
                if (
                  ...
                  (10 == (0 | j) &&
                    ((j = 0),
                    (c[(b + 8) >> 2] = a),
                    g ? ((i = k), (a = l), (j = 11)) : ((i = k), (a = l), (g = 0))),
                    11 == (0 | j) && ((f[(b + 20) >> 2] = 1 - e), (f[(b + 24) >> 2] = e)),
                    a ? ((c[(b + 12) >> 2] = i), (c[(b + 16) >> 2] = i + 1)) : (a = 0));
                } else a = l;
                q = 0 | c[(b + 36) >> 2];
                a: do {
                  if (0 < (0 | q)) {
          ...
          function _b(a, b) {
            ...
            switch (
              ((g[h >> 3] = a = +a),
              (f = 0 | Rc(0 | (d = 0 | c[h >> 2]), 0 | (e = 0 | c[(h + 4) >> 2]), 52)),
              z(),
              2047 & f)
            ) {
              case 0:
                ((d =
                  0 != a ? ((a = +_b(0x10000000000000000 * a, b)), ((0 | c[b >> 2]) - 64) | 0) : 0),
                  (c[b >> 2] = d));
                break;
              case 2047:
                break;
          ...
          function bc(b, d, e) {
            ...
            ((S = (S + 144) | 0),
              Uc(0 | (i = g), 640, 144),
              (c[(i + 48) >> 2] = h = (h = (-2 - b) | 0) >>> 0 < 256 ? h : 256),
              (c[(f = (i + 20) | 0) >> 2] = b),
              (j = ((c[(i + 44) >> 2] = b) + h) | 0),
              (c[(b = (i + 16) | 0) >> 2] = j),
              (c[(i + 28) >> 2] = j),
          ...
          function dc(b, e, f, g, h, i) {
            ...
            ((S = (S + 560) | 0),
              (m = (H + 32) | 0),
              (E = (12 + (l = ((F = G = H) + 540) | 0)) | (c[(t = (H + 536) | 0) >> 2] = 0)),
              tc(e),
              (B =
                (0 | (j = 0 | z())) < 0
                  ? (tc((e = -e)), (j = 0 | z()), (D = 1), 2539)
                  : ((D = (0 != ((2049 & h) | 0)) & 1),
                    0 == ((2048 & h) | 0) ? (0 == ((1 & h) | 0) ? 2540 : 2545) : 2542)));
            do {
              if (!0 & (2146435072 == ((2146435072 & j) | 0)))
                ((G = 0 != ((32 & i) | 0)),
                  oc(b, 32, f, (j = (D + 3) | 0), -65537 & h),
                  hc(b, B, D),
                  hc(b, (e != e) | !1 ? (G ? 2566 : 2570) : G ? 2558 : 2562, 3),
                  oc(b, 32, f, j, 8192 ^ h));
              else {
                if (
                  ((j = 0 != (q = 2 * +_b(e, t))) && (c[t >> 2] = (0 | c[t >> 2]) - 1),
                  97 == (0 | (w = 32 | i)))
                ) {
                ...
                for (
                  k = (0 | g) < 0 ? 6 : g,
                    e = j
                      ? ((l = ((0 | c[t >> 2]) - 28) | 0), (c[t >> 2] = l), 268435456 * q)
                      : ((l = 0 | c[t >> 2]), q),
                    m = C = (0 | l) < 0 ? m : (m + 288) | 0;
                  (c[m >> 2] = y = ~~e >>> 0), (m = (m + 4) | 0), 0 != (e = 1e9 * (e - (y >>> 0)));
                );
                if (((y = C), 0 < (0 | l))) {
                  j = C;
                  do {
                    if (((o = (0 | l) < 29 ? l : 29), j >>> 0 <= (l = (m + -4) | 0) >>> 0)) {
                      for (
                        n = 0;
                        (s = 0 | Mc(0 | (s = 0 | Sc(0 | c[l >> 2], 0, 0 | o)), 0 | z(), 0 | n, 0)),
                          (x =
                            0 |
                            Mc(
                              0 | s,
                              ...
                              0 |
                                (x =
                                  0 |
                                  Lc(0 | (n = 0 | Qc(0 | s, 0 | u, 1e9, 0)), 0 | z(), -1e9, -1)),
                              0 | z(),
                            )),
                          z(),
                          (c[l >> 2] = x),
                ...
                if ((0 | l) < 0) {
                  ...
                  do {
                    if (((r = (0 | (r = (0 - l) | 0)) < 9 ? r : 9), j >>> 0 < m >>> 0)) {
                      for (
                        o = ((1 << r) - 1) | 0, n = r ? 1e9 >>> r : 1e9, p = 0, l = j;
                        (x = 0 | c[l >> 2]),
                          (c[l >> 2] = (r ? x >>> r : x) + p),
                          (p = 0 | v(x & o, n)),
                          (l = (l + 4) | 0) >>> 0 < m >>> 0;
                ...
                if (j >>> 0 < s >>> 0) {
                  if (((l = (9 * (((y - j) | 0) >> 2)) | 0), 10 <= (n = 0 | c[j >> 2]) >>> 0))
                    for (m = 10; (l = (l + 1) | 0), (m = (10 * m) | 0) >>> 0 <= n >>> 0; );
                } else l = 0;
                if (
                  (0 |
                    (m =
                      (k -
                        (102 == (0 | w) ? 0 : l) +
                        ((((u = 0 != (0 | k)) & (t = 103 == (0 | w))) << 31) >> 31)) |
                      0)) <
                  ((((9 * ((x = (s - y) | 0) >> 2)) | 0) - 9) | 0)
                ) {
                  if (
                    ((g = (C + 4 + (((m = ((0 | (x = (m + 9216) | 0)) / 9) | 0) - 1024) << 2)) | 0),
                    (0 | (m = (x + (0 | v(m, -9))) | 0)) < 8)
                  )
                  ...
                  if (
                    ...
                    ((q = 0 == ((1 & m) | 0) ? 9007199254740992 : 9007199254740994),
                    (e = o >>> 0 < (x = n >>> 1) >>> 0 ? 0.5 : p & ((0 | o) == (0 | x)) ? 1 : 1.5),
                    D && ((q = (x = 45 == (0 | a[B >> 0])) ? -q : q), (e = x ? -e : e)),
                    (c[g >> 2] = r),
                    q + e != q)
                  ) {
                    ...
                    if (((l = (9 * (((y - j) | 0) >> 2)) | 0), 10 <= (o = 0 | c[j >> 2]) >>> 0))
                      for (n = 10; (l = (l + 1) | 0), (n = (10 * n) | 0) >>> 0 <= o >>> 0; );
                  } else m = g;
                    ...
                    if (
                      ...
                      if (s && 0 != (0 | (A = 0 | c[(w + -4) >> 2])))
                        if (((A >>> 0) % 10) | 0) m = 0;
                          ...
                          for (
                            j = 10, m = 0;
                            (m = (m + 1) | 0), !(((A >>> 0) % ((j = (10 * j) | 0) >>> 0)) | 0);
                          );
                      else m = 9;
                      if (((j = (((9 * (((w - y) | 0) >> 2)) | 0) - 9) | 0), 102 == (32 | n))) {
                ...
                if (((o = (g = 0 != (0 | k)) ? 1 : (h >>> 3) & 1), (p = 102 == (32 | n))))
                  j = (u = 0) < (0 | l) ? l : 0;
                else {
                  if (
                    (((m = E) -
                      (j = 0 | mc((j = (0 | l) < 0 ? r : l), (((0 | j) < 0) << 31) >> 31, E))) |
                      0) <
                    2
                  )
                    for (; (a[(j = (j + -1) | 0) >> 0] = 48), ((m - j) | 0) < 2; );
                  ((a[(j + -1) >> 0] = 43 + ((l >> 31) & 2)),
                    (a[(j = (j + -2) | 0) >> 0] = n),
                    (j = (m - (u = j)) | 0));
                }
                if (
                  (oc(b, 32, f, (j = (D + 1 + k + o + j) | 0), h),
                  hc(b, B, D),
                  oc(b, 48, f, j, 65536 ^ h),
                  p)
                ) {
                  ...
                  do {
                    if (((l = 0 | mc(0 | c[m >> 2], 0, r)), (0 | m) == (0 | o)))
                      (0 | l) == (0 | r) && ((a[n >> 0] = 48), (l = n));
                    else if (G >>> 0 < l >>> 0)
                      for (Vc(0 | G, 48, (l - F) | 0); G >>> 0 < (l = (l + -1) | 0) >>> 0; );
                  } while ((hc(b, l, (p - l) | 0), (m = (m + 4) | 0) >>> 0 <= C >>> 0));
                  if (
                    ((0 == ((8 & h) | 0)) & (1 ^ g) || hc(b, 2574, 1),
                    (m >>> 0 < w >>> 0) & (0 < (0 | k)))
                  )
                    for (;;) {
                      if (G >>> 0 < (l = 0 | mc(0 | c[m >> 2], 0, r)) >>> 0)
                        for (Vc(0 | G, 48, (l - F) | 0); G >>> 0 < (l = (l + -1) | 0) >>> 0; );
                      if (
                        (hc(b, l, (0 | k) < 9 ? k : 9),
                        (l = (k + -9) | 0),
                  ...
                  if ((x >>> 0 < (g = s ? w : (x + 4) | 0) >>> 0) & (-1 < (0 | k))) {
                    ((t = 0 == ((8 & h) | 0)),
                      ...
                      (o = x));
                    do {
                      (0 | (l = 0 | mc(0 | c[o >> 2], 0, r))) == (0 | r) &&
                        ((a[p >> 0] = 48), (l = p));
                      do {
                        if ((0 | o) == (0 | x)) {
                          if (((m = (l + 1) | 0), hc(b, l, 1), t & ((0 | k) < 1))) {
                            l = m;
                            break;
                          }
                          (hc(b, 2574, 1), (l = m));
                          ...
                          if (l >>> 0 <= G >>> 0) break;
                          for (Vc(0 | G, 48, (l + n) | 0); G >>> 0 < (l = (l + -1) | 0) >>> 0; );
                        }
                      } while (0);
                    } while (
                      (hc(b, l, (0 | (F = (s - l) | 0)) < (0 | k) ? F : k),
                      ((o = (o + 4) | 0) >>> 0 < g >>> 0) & (-1 < (0 | (k = (k - F) | 0))))
                    );
                  }
                  (oc(b, 48, (k + 18) | 0, 18, 0), hc(b, u, (E - u) | 0));
                }
                oc(b, 32, f, j, 8192 ^ h);
              }
            } while (0);
          ...
          function gc(d, e, f, h, i) {
            ...
            a: for (;;) {
                ...
                c: do {
                  if (10 == (0 | u)) {
                    ...
                    do {
                      ...
                      ((j = (j + 1) | 0), (c[D >> 2] = l = (l + 2) | 0), 37 == (0 | a[l >> 0]))
                    );
                  }
                } while (0);
              } while (((j = (j - p) | 0), A && hc(d, p, j), 0 != (0 | j)));
              if (
                ((l = 0 | c[D >> 2]),
                (o =
                  0 | ac((j = 0 | a[(l + 1) >> 0]))
              ...
              do {
                if (46 == (0 | a[l >> 0])) {
                  if (42 != (0 | a[(j = (l + 1) | 0) >> 0])) {
                    ((c[D >> 2] = j), (n = 0 | ic(D)), (j = 0 | c[D >> 2]));
                    break;
                  }
                  if (0 | ac((k = 0 | a[(j = (l + 2) | 0) >> 0])) && 36 == (0 | a[(l + 3) >> 0])) {
                    ((c[(i + ((k + -48) << 2)) >> 2] = 10),
                  ...
                  (A
                    ? ((o = (3 + (0 | c[f >> 2])) & -4), (k = 0 | c[o >> 2]), (c[f >> 2] = o + 4))
                    : (k = 0),
                    (c[D >> 2] = j),
                    (n = k));
                } else ((j = l), (n = -1));
              ...
              for (o = 0; ; ) {
                ...
                if (
                  ((c[D >> 2] = k = (j + 1) | 0),
                  !(
                    (((m = 255 & (l = 0 | a[((0 | a[j >> 0]) - 65 + (16 + ((58 * o) | 0))) >> 0])) -
                      1) |
                      0) >>>
                      0 <
                    8
              ...
              d: do {
                if (53 == (0 | u)) {
                  ((l =
                    ((u = 0) != (0 | o)) & (3 == ((15 & (l = 0 | a[j >> 0])) | 0)) ? -33 & l : l),
                    (j = -65537 & q),
                    (r = 0 == ((8192 & q) | 0) ? q : j));
                  e: do {
                    switch (0 | l) {
                                  ...
                                  (function (b, c, d) {
                                    if (
                                      ...
                                      for (
                                        ...
                                        (a[(d = (d + -1) | 0) >> 0] = (7 & b) | 48),
                                          !(
                                            (0 == (0 | (b = 0 | Rc(0 | b, 0 | c, 3)))) &
                                            (0 == (0 | (c = 0 | z())))
                                          );
                                      );
                                    return 0 | d;
                                  })((p = 0 | c[(q = B) >> 2]), (q = 0 | c[(q + 4) >> 2]), v))) |
                              0)) <
                            (0 | n))
                            ? n
                            : (l + 1) | 0),
                      ...
                      case 100:
                        ...
                        ((l = (0 != ((2049 & r) | 0)) & 1),
                          (m = 0 == ((2048 & r) | 0) ? (0 == ((1 & r) | 0) ? 2522 : 2524) : 2523),
                          (u = 70));
                        break e;
                      case 117:
                        ((j = 0 | c[(k = B) >> 2]),
                  ...
                  f: do {
                    if (65 == (0 | u))
                      ((o =
                        0 | kc((p = 0 | c[(q = B) >> 2]), (q = 0 | c[(q + 4) >> 2]), v, 32 & m)),
                        (n = k),
                        (l = (G = (0 == ((8 & j) | 0)) | ((0 == (0 | p)) & (0 == (0 | q))))
                          ? 0
                          : 2),
                        (k = G ? 2522 : (2522 + (m >>> 4)) | 0),
                        (u = 71));
                    else if (70 == (0 | u))
                      ((o = 0 | mc((p = j), (q = k), v)), (j = r), (k = m), (u = 71));
                    else if (78 == (0 | u)) {
                      for (j = u = 0, o = l; (k = 0 | c[o >> 2]); ) {
                        if ((m = (0 | (k = 0 | pc(C, k))) < 0) | (((n - j) | 0) >>> 0 < k >>> 0)) {
                          u = 82;
                          break;
                        }
                  ...
                  if (71 == (0 | u))
                    ...
                    ((u = 0), oc(d, 32, s, j, 8192 ^ r), (j = (0 | j) < (0 | s) ? s : j));
                    break;
                  }
                  (oc(
                    d,
              ...
              if (91 == (0 | u) && !d)
                if (m) {
                  for (e = 1; (j = 0 | c[(i + (e << 2)) >> 2]); )
                    if ((jc((h + (e << 3)) | 0, j, f), 10 <= (e = (e + 1) | 0) >>> 0)) {
                      e = 1;
                      break g;
                    }
                  for (j = 0; ; ) {
          ...
          function ic(b) {
            var d = 0,
              ...
              f = 0,
              e = 0 | c[(b |= 0) >> 2];
            if (0 | ac(((d = 0 | a[e >> 0]) << 24) >> 24))
              for (
                f = d, d = 0;
                (d = (((10 * d) | 0) - 48 + ((f << 24) >> 24)) | 0),
                  (c[b >> 2] = e = (e + 1) | 0),
                  0 != (0 | ac(((f = 0 | a[e >> 0]) << 24) >> 24));
              );
            else d = 0;
            return 0 | d;
          }
            ...
            if (((e |= 0), (f |= 0), !((0 == (0 | (b |= 0))) & (0 == (0 | (c |= 0))))))
              for (
                ...
                (a[(e = (e + -1) | 0) >> 0] = 0 | d[(480 + (15 & b)) >> 0] | f),
                  !((0 == (0 | (b = 0 | Rc(0 | b, 0 | c, 4)))) & (0 == (0 | (c = 0 | z()))));
              );
            return 0 | e;
          }
          function mc(b, c, d) {
              ...
              for (
                ...
                (g =
                  ...
                  Mc(
                    ...
                    0 |
                      (g =
                        0 | Lc(0 | (b = 0 | Qc(0 | b, 0 | c, 10, 0)), 0 | (c = 0 | z()), -10, -1)),
                    0 | z(),
                  )),
                  z(),
            ...
            if (b)
              for (
                ;
                (f = 255 & (((g = b) + (0 | v((b = ((b >>> 0) / 10) | 0), -10))) | 48)),
                  (a[(d = (d + -1) | 0) >> 0] = f),
                  10 <= g >>> 0;
              );
            return 0 | d;
          ...
          function oc(a, b, c, d, e) {
            ...
            if (
              ...
              if (
                (Vc(0 | f, ((b << 24) >> 24) | 0, 0 | ((e = (c - d) | 0) >>> 0 < 256 ? e : 256)),
                255 < e >>> 0)
              ) {
                for (d = e; hc(a, f, 256), 255 < (d = (d + -256) | 0) >>> 0; );
                e &= 255;
              }
              hc(a, f, e);
            }
          ...
          function tc(b) {
            return ((g[h >> 3] = b = +b), (b = 0 | c[h >> 2]), y(0 | c[(h + 4) >> 2]), 0 | b);
          }
          function wc(a, b, d) {
            ((b |= 0), (d |= 0));
            var g,
          ...
          function xc(a, b) {
            var d = 0,
              ...
              f = (4 + (a |= 0)) | 0;
            (31 < (b |= 0) >>> 0
              ? ((d = 0 | c[f >> 2]), (c[a >> 2] = d), (b = (b + -32) | (e = c[f >> 2] = 0)))
              : ((d = 0 | c[a >> 2]), (e = 0 | c[f >> 2])),
            ...
            a: do {
              if (
                ...
                for (b = h, i = 1, h = 0 == (0 | f); ; ) {
                  ...
                  if (
                    (0 | oa((h = (b + (0 - (0 | c[(g + (e << 2)) >> 2]))) | 0), 0 | c[l >> 2])) <
                    1
                  ) {
                    ((h = d), (d = 10));
                    break;
          ...
          function zc(a, b) {
            var d = 0,
              ...
              g = (4 + (a |= 0)) | 0;
            (31 < (b |= 0) >>> 0
              ? ((d = 0 | c[a >> 2]), (c[g >> 2] = d), (b = (b + -32) | (e = c[a >> 2] = 0)))
              : ((d = 0 | c[g >> 2]), (e = 0 | c[a >> 2])),
              (c[g >> 2] = ((g = (32 - b) | 0) ? e >>> g : e) | (d << b)),
              (c[a >> 2] = e << b));
          }
          function Ac(a) {
            var b;
            return (b = 0 | Bc(((0 | c[(a |= 0) >> 2]) - 1) | 0))
              ? 0 | b
              : 0 | (0 == (0 | (a = 0 | Bc(0 | c[(a + 4) >> 2]))) ? 0 : (a + 32) | 0);
          }
          function Bc(a) {
            var b = 0;
            if ((a |= 0))
          ...
          function Ec(a) {
            ...
            do {
              if (a >>> 0 < 245) {
                if (
                  ((m = 0 | c[923]),
                  (3 & (d = (a = (k = a >>> 0 < 11 ? 16 : (a + 11) & -8) >>> 3) ? m >>> a : m)) | 0)
                )
                  return (
                    (a =
                      0 |
                ...
                if (((k = -8 & (a = (a + 11) | 0)), (e = 0 | c[924]))) {
                  ...
                  a: do {
                    if (a)
                      for (
                        h = k << (31 == ((f = 0) | j) ? 0 : (25 - (j >>> 1)) | 0), i = a, a = 0;
                        ;
                      ) {
                  ...
                  if (
                    ...
                    do {
                      if ((0 | b) == (0 | g)) {
                        ...
                        ((v = 0 | c[(g + 8) >> 2]), (c[(v + 12) >> 2] = b), (c[(b + 8) >> 2] = v));
                    } while (0);
                    do {
                      if (h) {
                        if (
                          ((a = 0 | c[(g + 28) >> 2]),
                          (0 | g) == (0 | c[(d = (3996 + (a << 2)) | 0) >> 2]))
                        ) {
                          if (!(c[d >> 2] = b)) {
                            ((e &= ~(1 << a)), (c[924] = e));
                            break;
            ...
            if (
              0 | (a = 0 | c[1033]) &&
              ((n = ((l = 0 | c[1031]) + k) | 0) >>> 0 <= l >>> 0) | (a >>> 0 < n >>> 0)
            )
              return ((S = w), (v = 0) | v);
            d: do {
              if (4 & c[1034]) ((b = 0), (r = 143));
                ...
                e: do {
                  if (d) {
                    ...
                    if ((b = (g - h) & e) >>> 0 < 2147483647)
                      if ((0 | (a = 0 | Jc(b))) == (((0 | c[f >> 2]) + (0 | c[q >> 2])) | 0)) {
                        if (-1 != (0 | a)) {
                          ((h = a), (g = b), (r = 145));
                          break d;
                        }
                ...
                do {
                  if (128 == (0 | r))
                    if (
                      ...
                      if (0 | (q = 0 | c[1033]) && (p >>> 0 <= o >>> 0) | (q >>> 0 < p >>> 0)) {
                        b = 0;
                        break;
                      }
                      if ((0 | (a = 0 | Jc(b))) == (0 | d)) {
                ...
                do {
                  if (136 == (0 | r)) {
                    ...
                    if (2147483647 <= (a = (j - b + (a = 0 | c[1043])) & (0 - a)) >>> 0) {
                      ((h = e), (g = b), (r = 145));
                      break d;
                    }
                    if (-1 == (0 | Jc(a))) {
            ...
            if (
              ...
              f: do {
                if (j) {
                  ...
                  for (
                    h >>> 0 < (0 | c[927]) >>> 0 && (c[927] = h), d = (h + g) | 0, a = 4140;
                    ;
                  ) {
                    if ((0 | c[a >> 2]) == (0 | d)) {
                      r = 162;
                  ...
                  if (162 == (0 | r) && 0 == ((8 & c[(a + 12) >> 2]) | 0)) {
                    ((c[a >> 2] = h),
                      ...
                      (k =
                        ((l = (h + (0 == ((7 & (l = (h + 8) | 0)) | 0) ? 0 : (0 - l) & 7)) | 0) +
                          m) |
                        0),
                      (i =
                        ((b = (d + (0 == ((7 & (b = (d + 8) | 0)) | 0) ? 0 : (0 - b) & 7)) | 0) -
                          l -
                          m) |
                        0),
                      (c[(l + 4) >> 2] = 3 | m));
          ...
          function Fc(a) {
            ...
            if ((a |= 0)) {
                ...
                if (1 & a) j = i = d;
                  ...
                  if (f) {
                    if (
                      ...
                      !(c[((0 | c[(j = (f + 16) | 0) >> 2]) == (0 | g) ? j : (f + 20) | 0) >> 2] =
                        d)
                    ) {
                      ((j = i = g), (b = h));
                      break;
                    ...
                    ((c[(d + 24) >> 2] = f),
                      ...
                      (a = 0 | c[(b + 4) >> 2]) && ((c[(d + 20) >> 2] = a), (c[(a + 24) >> 2] = d)),
                      (j = i = g),
                      (b = h));
                  } else ((j = i = g), (b = h));
                }
              ...
              if (!(k >>> 0 <= i >>> 0) && 1 & (d = 0 | c[(a = (k + 4) | 0) >> 2])) {
                if (2 & d)
                  ((c[a >> 2] = -2 & d), (c[(j + 4) >> 2] = 1 | b), (f = c[(i + b) >> 2] = b));
                else {
                  if ((0 | c[929]) == (0 | k))
                    return (
                      (k = ((0 | c[926]) + b) | 0),
                      ...
                      (c[929] = j),
                      (c[(j + 4) >> 2] = 1 | k),
                      (0 | j) != (0 | c[928]) ? void 0 : ((c[928] = 0), void (c[925] = 0))
                    );
                  if ((0 | c[928]) == (0 | k))
                    return (
                      (k = ((0 | c[925]) + b) | 0),
                  ...
                  do {
                    if (d >>> 0 < 256) {
                      if (
                        ((b = 0 | c[(k + 8) >> 2]), (0 | (a = 0 | c[(k + 12) >> 2])) == (0 | b))
                      ) {
                        c[923] = c[923] & ~(1 << e);
                        break;
                      }
                    ...
                    if (0 | g) {
                      if (
                        ...
                        !(c[((0 | c[(h = (g + 16) | 0) >> 2]) == (0 | k) ? h : (g + 20) | 0) >> 2] =
                          d)
                      )
                        break;
                      ((c[(d + 24) >> 2] = g),
                  ...
                  if (((c[(j + 4) >> 2] = 1 | f), (c[(i + f) >> 2] = f), (0 | j) == (0 | c[928])))
                    return void (c[925] = f);
                }
                if (((a = f >>> 3), f >>> 0 < 256))
                  return (
          ...
          function Gc(a, b) {
            ...
            do {
              if (1 & d) ((i = a), (a = b));
                ...
                if (((h = (e + b) | 0), (0 | c[928]) == (0 | (g = (a + (0 - e)) | 0)))) {
                ...
                if (f) {
                  if (
                    ...
                    !(c[((0 | c[(i = (f + 16) | 0) >> 2]) == (0 | g) ? i : (f + 20) | 0) >> 2] = b)
                  ) {
                    ((i = g), (a = h));
                    break;
                  }
                  ((c[(b + 24) >> 2] = f),
                    ...
                    (d = 0 | c[(a + 4) >> 2]) && ((c[(b + 20) >> 2] = d), (c[(d + 24) >> 2] = b)),
                    (i = g),
                    (a = h));
                } else ((i = g), (a = h));
              }
            ...
            if (2 & (b = 0 | c[(d = (j + 4) | 0) >> 2]))
              ((c[d >> 2] = -2 & b), (c[(i + 4) >> 2] = 1 | a), (c[(i + a) >> 2] = a));
            else {
              if ((0 | c[929]) == (0 | j))
                return (
                  (j = ((0 | c[926]) + a) | 0),
                  ...
                  (c[929] = i),
                  (c[(i + 4) >> 2] = 1 | j),
                  (0 | i) == (0 | c[928]) && ((c[928] = 0), void (c[925] = 0))
                );
              if ((0 | c[928]) == (0 | j))
                return (
                  (j = ((0 | c[925]) + a) | 0),
              ...
              do {
                ...
                if (0 | f) {
                  if (
                    ...
                    !(c[((0 | c[(h = (f + 16) | 0) >> 2]) == (0 | j) ? h : (f + 20) | 0) >> 2] = b)
                  )
                    break;
                  ((c[(b + 24) >> 2] = f),
                    0 | (d = 0 | c[(a = (j + 16) | 0) >> 2]) &&
              ...
              if (((c[(i + 4) >> 2] = 1 | g), (c[(i + g) >> 2] = g), (0 | i) == (0 | c[928])))
                return ((c[925] = g), 0);
              a = g;
            }
            if (((d = a >>> 3), a >>> 0 < 256))
              ...
              : ((-64 - b) | 0) >>> 0 < (d |= 0) >>> 0 ||
                  !(b =
                    ...
                    (function (a, b) {
                      ...
                      if (((-64 - a) | 0) >>> 0 <= b >>> 0) return ((c[922] = 48), (h = 0) | h);
                      if (!(d = 0 | Ec((12 + (g = b >>> 0 < 11 ? 16 : (b + 11) & -8) + a) | 0)))
                        return (h = 0) | h;
                      f = (d + -8) | 0;
                      do {
                        if ((a + -1) & d) {
                          if (
                            ((e =
                              15 < (((e = (((d + a + -1) & (0 - a)) - 8) | 0) - (b = f)) | 0) >>> 0
                                ? e
                                : (e + a) | 0),
                            (d =
                              ((-8 & (i = 0 | c[(a = (d + -4) | 0) >> 2])) - (b = (e - b) | 0)) |
                              0),
                            3 & i)
                          ) {
          ...
          function Jc(a) {
            var b,
              d = 0;
            return (a = ((b = 0 | c[(d = 4208) >> 2]) + (0 | a)) | 0) >>> 0 > (0 | H()) >>> 0 &&
              0 == (0 | J(0 | a))
              ? ((c[922] = 48), -1)
              : ((c[d >> 2] = a), 0 | b);
          }
            ...
            return (
              (c =
                ...
                (function (a, b) {
                  ...
                  return (
                    (a =
                      (((c = 0 | v((e = 65535 & (b |= 0)), (f = 65535 & (a |= 0)))) >>> 16) +
                        (0 | v(e, (d = a >>> 16)))) |
                      0),
                    (b = 0 | v((e = b >>> 16), f)),
                    0 |
                      (y(((a >>> 16) + (0 | v(e, d)) + ((((65535 & a) + b) | 0) >>> 16)) | 0),
                      ((a + b) << 16) | (65535 & c) | 0)
                  );
                })((e = a |= 0), (f = c |= 0))),
              (a = 0 | z()),
          ...
          function Pc(a, b, d, e, f) {
            ...
            do {
              if (h) {
                ...
                if (((g = (h - 1) | 0) & h) | 0) {
                  ((a =
                    ((((m = (32 - (i = (33 + (0 | w(0 | h)) - (0 | w(0 | k))) | 0)) | 0) - 1) >>
                      31) &
                      (k >>> ((o = (i - 32) | 0) >>> 0))) |
                    (((k << m) | (l >>> ((h = i) >>> 0))) & (b = o >> 31))),
                    (b &= k >>> (i >>> 0)),
              ...
              if (g)
                return (
                  0 | f && ((c[f >> 2] = (k >>> 0) % (h >>> 0)), (c[(f + 4) >> 2] = 0)),
                  (p = ((k >>> (o = 0)) / (h >>> 0)) >>> 0),
                  0 | (y(0 | o), p)
                );
              if (!l)
                return (
                  0 | f && ((c[f >> 2] = 0), (c[(f + 4) >> 2] = (k >>> 0) % (i >>> 0))),
                  (p = ((k >>> (o = 0)) / (i >>> 0)) >>> 0),
                  0 | (y(0 | o), p)
                );
              if (!((g = (i - 1) | 0) & i))
                return (
                  0 | f && ((c[f >> 2] = 0 | a), (c[(f + 4) >> 2] = (g & k) | (0 & b))),
                  (p = k >>> (((o = 0) | Oc(0 | i)) >>> 0)),
                  0 | (y(0 | o), p)
                );
              if ((g = ((0 | w(0 | i)) - (0 | w(0 | k))) | 0) >>> 0 <= 30) {
                ((a = (k << (i = (31 - g) | 0)) | (l >>> ((h = b = (g + 1) | 0) >>> 0))),
                  (b = k >>> (b >>> 0)),
                  (g = 0),
                  (i = l << i));
                break;
            ...
            return (
              ...
              (p = (-2 & ((g << 1) | 0)) | i),
              0 |
                (y(0 | (o = ((0 | g) >>> 31) | ((k | h) << 1) | (0 & ((h << 1) | (g >>> 31))) | j)),
                p)
            );
          }
          function Qc(a, b, c, d) {
          ...
          function Vc(b, d, e) {
            ...
            if (((d &= 255), 67 <= (0 | e))) {
              ...
              for (
                i = d | (d << 8) | (d << 16) | (d << 24), g = ((f = (-4 & h) | 0) - 64) | 0;
                (0 | b) <= (0 | g);
              )
                ((c[b >> 2] = i),
                  (c[(b + 4) >> 2] = i),
                  ...
                  if (
                    ...
                    (0 |
                      (b =
                        0 |
                        (function (a) {
                          return 0 | (a = ((a |= 0) << 16) >> 16 ? ((c[922] = 65535 & a), -1) : 0);
              ...
              function (a, b, d) {
                ...
                return (
                  Uc(
                    ...
                    0 | (b |= 0),
                    0 | (a = (d |= 0) >>> 0 < (a = ((0 | c[(a + 16) >> 2]) - f) | 0) >>> 0 ? d : a),
                  ),
                  (c[e >> 2] = (0 | c[e >> 2]) + a),
                  0 | d
                );
            ...
            _ = [
              ...
              function (p, b) {
                var j,
                  ...
                  g = 0 | c[(p + 316) >> 2],
                  h = 0 | c[(p + 320) >> 2];
                (-1 == (0 | (o = 0 | c[(k = (e + ((b |= 0) << 5) + 8) | 0) >> 2]))
                  ? ((c[(g + (b << 2)) >> 2] =
                      c[((0 | c[(p + 148) >> 2]) + (c[(e + (b << 5) + 16) >> 2] << 2)) >> 2]),
                    (f[(h + (b << 2)) >> 2] = 1))
                  : ((m = 0 | c[(l = (e + (b << 5) + 16) | 0) >> 2]),
                    (n = 0 | c[((0 | c[(p + 152) >> 2]) + (m << 2)) >> 2]),
                    $[3 & c[(e + (o << 5) + 24) >> 2]](
                      p,
                      o,
                      n,
                      n,
                      0 | c[((0 | c[(p + 60) >> 2]) + ((24 * m) | 0) + 16) >> 2],
                    ),
                    (k = 0 | c[k >> 2]),
                    (f[(g + (b << 2)) >> 2] =
                      +f[((0 | c[(p + 148) >> 2]) + (c[l >> 2] << 2)) >> 2] *
                      +f[(g + (k << 2)) >> 2]),
                    (c[(h + (b << 2)) >> 2] = c[(h + (k << 2)) >> 2])),
                  (0 | d[(4 + (0 | c[p >> 2])) >> 0]) < 4 ||
                    ((e = 0 | c[j >> 2]),
                    ...
                    -1 == (0 | (e = 0 | c[(e + (b << 5) + 8) >> 2]))
                      ? ((e = 0 | c[(p + 156) >> 2]),
                        (c[(g + (h << 2)) >> 2] = c[(e + (o << 2)) >> 2]),
                        (c[(g + ((b = 1 | h) << 2)) >> 2] = c[(e + ((k = 1 | o) << 2)) >> 2]),
                        (c[(g + ((n = 2 | h) << 2)) >> 2] = c[(e + ((m = 2 | o) << 2)) >> 2]),
                        (f[(g + ((e = 3 | h) << 2)) >> 2] = 1),
                        (l = 0 | c[(p + 160) >> 2]),
                        (c[(j + (h << 2)) >> 2] = c[(l + (o << 2)) >> 2]),
                        (c[(j + (b << 2)) >> 2] = c[(l + (k << 2)) >> 2]),
              ...
              function (a, b) {
                ...
                if (
                  ...
                  (w = 0 | c[(a + 316) >> 2]),
                  (x = 0 | c[(a + 320) >> 2]),
                  -1 == (0 | (p = 0 | c[(B = (e + ((b |= 0) << 5) + 8) | 0) >> 2])))
                )
                  ((G = 0 | c[(e + (b << 5) + 16) >> 2]),
                    (c[(w + (b << 2)) >> 2] = c[((0 | c[(a + 268) >> 2]) + (G << 2)) >> 2]),
                    (c[(x + (b << 2)) >> 2] = c[((0 | c[(a + 272) >> 2]) + (G << 2)) >> 2]));
                else {
                  for (
                    v = 0 | c[(C = (e + (b << 5) + 16) | 0) >> 2],
                      j = 0 | c[((0 | c[(z = (a + 276) | 0) >> 2]) + (v << 2)) >> 2],
                      c[F >> 2] = j,
                      v = 0 | c[((0 | c[(A = (a + 280) | 0) >> 2]) + (v << 2)) >> 2],
                      c[(D = (F + 4) | 0) >> 2] = v,
                      E = 1 == (0 | c[(e + (p << 5) + 12) >> 2]) ? -10 : -0.10000000149011612,
                      c[s >> 2] = j,
                      c[(j = (4 + s) | 0) >> 2] = v,
                      $[3 & c[(v = (e + (p << 5) + 24) | 0) >> 2]](a, p, s, r, 1),
                      h = (4 + q) | 0,
                      e = (4 + r) | 0,
                      g = (t + 4) | 0,
                      i = 9,
                ...
                ((0 | d[(4 + (0 | c[a >> 2])) >> 0]) < 4 ||
                  ...
                  -1 == (0 | (e = 0 | c[(e + (b << 5) + 8) >> 2]))
                    ? ((e = 0 | c[(a + 296) >> 2]),
                      (c[(g + (h << 2)) >> 2] = c[(e + (i << 2)) >> 2]),
                      (c[(g + ((F = 1 | h) << 2)) >> 2] = c[(e + ((D = 1 | i) << 2)) >> 2]),
                      (c[(g + ((b = 2 | h) << 2)) >> 2] = c[(e + ((G = 2 | i) << 2)) >> 2]),
                      (f[(g + ((e = 3 | h) << 2)) >> 2] = 1),
                      (a = 0 | c[(a + 300) >> 2]),
                      (c[(j + (h << 2)) >> 2] = c[(a + (i << 2)) >> 2]),
                      (c[(j + (F << 2)) >> 2] = c[(a + (D << 2)) >> 2]),
            ...
            $ = [
              ...
              function (a, b, d, e, h) {
                ...
                if (
                  ((S = (S + 32) | 0),
                  (Y = Z),
                  (b = 0 | c[((0 | c[(308 + (a |= 0)) >> 2]) + ((b |= 0) << 5) + 16) >> 2]),
                  (i = 0 | c[(a + 60) >> 2]),
                  ...
                  do {
                    ...
                    do {
                      if (i & a & !(B < 0) & !(z < 0)) {
                        ...
                        if (k + j <= 1) {
                          ((f[(e + (M << 3)) >> 2] =
                            ...
                            k * +f[(R + ((i = (b + 1) | 0) << 3)) >> 2] +
                            j * +f[(R + ((_ = (b + V) | 0) << 3)) >> 2]),
                            (z = z * +f[(R + (b << 3) + 4) >> 2] + k * +f[(R + (i << 3) + 4) >> 2]),
                            (y = j * +f[(R + (_ << 3) + 4) >> 2]));
                          break;
                        }
                        ((f[(e + (M << 3)) >> 2] =
                          (C = k + -1 + j) *
                            +f[(R + ((a = (1 + (i = (b + V) | 0)) | 0) << 3)) >> 2] +
                          (z = 1 - k) * +f[(R + (i << 3)) >> 2] +
                          (y = 1 - j) * +f[(R + ((_ = (b + 1) | 0) << 3)) >> 2]),
                          (z = C * +f[(R + (a << 3) + 4) >> 2] + z * +f[(R + (i << 3) + 4) >> 2]),
                          (y *= +f[(R + (_ << 3) + 4) >> 2]));
                        break;
                      }
                      if (
                      ...
                      if (k + j <= 1) {
                        ((f[(e + (M << 3)) >> 2] = n + (l - n) * k + (r - n) * j),
                          (z = o + (m - o) * k),
                          (y = (s - o) * j));
                        break;
                      }
                      ((f[(e + (M << 3)) >> 2] = p + (r - p) * (z = 1 - k) + (l - p) * (y = 1 - j)),
                        (z = q + (s - q) * z),
                        (y *= m - q));
                      break;
                    } while (0);
                  } while (
                    ((f[(e + (M << 3) + 4) >> 2] = z + y), (0 | (M = (M + 1) | 0)) != (0 | h))
                  );
                  S = Z;
                }
              },
              function (a, b, d, e, g) {
                ...
                if (
                  ...
                  (k =
                    ...
                    (l = 0 == (0 | c[((0 | c[(a + 288) >> 2]) + (b << 2)) >> 2]) ? 1 : -1)),
                  (i =
                    (h *= i) *
                    (m = 0 == (0 | c[((0 | c[(a + 292) >> 2]) + (b << 2)) >> 2]) ? 1 : -1)),
                  (l *= h),
                  (m *= j),
          ...
          return {
            ...
            _csmGetDrawableCount: function (a) {
              ...
              return (
                ...
                (a |= 0)
                  ...
                  : ((c[b >> 2] = 1858), (c[(b + 4) >> 2] = 1411), ia(0, 1269, b), (S = d), -1)
              );
            },
            ...
            _csmGetParameterCount: function (a) {
              ...
              return (
                ...
                (a |= 0)
                  ...
                  : ((c[b >> 2] = 1610), (c[(b + 4) >> 2] = 1411), ia(0, 1269, b), (S = d), -1)
              );
            },
            ...
            _csmGetPartCount: function (a) {
              ...
              return (
                ...
                (a |= 0)
                  ? ((b = 0 | c[(a + 4) >> 2]), (S = d), 0 | b)
                  : ((c[b >> 2] = 1780), (c[(b + 4) >> 2] = 1411), ia(0, 1269, b), (S = d), -1)
              );
            },
            ...
            _csmMallocMoc: function (a) {
              var b,
                d = S;
              return ((S = (S + 16) | 0), Ic((b = d), 64, (a |= 0)), (S = d), 0 | c[b >> 2]);
            },
            _csmMallocModelAndInitialize: function (d) {
              ...
              return (
                (S = (S + 16) | 0),
                (b = f),
                0 != (0 | (d |= 0)) && 0 == (0 | Ic(b, 16, (e = 0 | Ha(d))))
                  ? (b = 0 | Ia(d, (d = 0 | c[b >> 2]), e)) || (Fc(d), (b = 0))
                  : (b = 0),
                (S = f),
                0 | b
              );
                    ...
                    ? d
                      ? e
                        ? ((i = 0 | c[(708 + (0 | c[a >> 2])) >> 2]),
                          ...
                          (c[(d + 4) >> 2] = c[(i + 8) >> 2]),
                          (c[e >> 2] = c[i >> 2]))
                        : ((c[g >> 2] = 1393), (c[(4 + g) >> 2] = 1487), ia(0, 1269, g))
                      : ((c[i >> 2] = 1393), (c[(i + 4) >> 2] = 1458), ia(0, 1269, i))
                    : ((c[h >> 2] = 1393), (c[(4 + h) >> 2] = 1431), ia(0, 1269, h))
                  : ((c[f >> 2] = 1393), (c[(f + 4) >> 2] = 1411), ia(0, 1269, f)),
                (S = j));
            },
            _csmResetDrawableDynamicFlags: function (a) {
              ...
              ((S = (S + 16) | 0),
                ...
                (a |= 0)
                  ? (c[(a + 428) >> 2] = 1)
                  : ((c[b >> 2] = 2318), (c[(b + 4) >> 2] = 1411), ia(0, 1269, b)),
                (S = d));
            },
            ...
            _csmUpdateModel: function (a) {
              ...
              ((S = (S + 16) | 0),
                (b = d),
                (a |= 0) ? Gb(a) : ((c[b >> 2] = 1595), (c[(b + 4) >> 2] = 1411), ia(0, 1269, b)),
                (S = d));
            },
          ...
          },
          {
            ...
            m: function (a) {
              ...
              for (var c = Math.max(qa(), 16777216); c < a; )
                c = c <= 536870912 ? ea(2 * c) : Math.min(ea((3 * c + 2147483648) / 4), 2130706432);
              return !!ra(c);
            },
            n: pa,
            o: function () {
          ...
          (b._csmGetDrawableMultiplyColors = Aa._csmGetDrawableMultiplyColors),
          (b._csmGetDrawableOpacities = Aa._csmGetDrawableOpacities),
          (b._csmGetDrawableParentPartIndices = Aa._csmGetDrawableParentPartIndices),
          (b._csmGetDrawableRenderOrders = Aa._csmGetDrawableRenderOrders),
          (b._csmGetDrawableScreenColors = Aa._csmGetDrawableScreenColors),
          ...
          (b._csmGetParameterTypes = Aa._csmGetParameterTypes),
        ...
        function Z() {
          function a() {
            if (!Y && ((Y = !0), !K)) {
              if ((P(ja), P(ka), b.onRuntimeInitialized && b.onRuntimeInitialized(), b.postRun))
                for (
        ...
        if (
          ...
          (b.dynCall_vii = Aa.dynCall_vii),
          (b.dynCall_viiiii = Aa.dynCall_viiiii),
          (b.asm = Aa),
          (b.ccall = function (a, c, d, f) {
            var g = {
                    ...
                    if (0 < d) {
                      for (var d = f + d - 1, h = 0; h < a.length; ++h) {
                        ...
                        if (
                          (l =
                            55296 <= l && l <= 57343
                              ? (65536 + ((1023 & l) << 10)) | (1023 & a.charCodeAt(++h))
                              : l) <= 127
                        ) {
                          if (d <= f) break;
                          g[f++] = l;
              ...
              h = (function (a) {
                var c = b["_" + a];
                return (
                  assert(c, "Cannot call unknown function " + a + ", make sure it is exported"), c
                );
              })(a),
              p = [];
            if (((a = 0), f))
          ...
          E &&
            ((String.prototype.startsWith ? E.startsWith(U) : 0 === E.indexOf(U)) ||
