...
export const useStudioStore = create<StudioState>((set, get: () => StudioState) => ({
  ...
  setCurrentArticle: (article: GardenArticle | null) =>
    set({
  ...
  setEditorMeta: (meta: Partial<EditorMeta>) =>
  ...
  setArticles: (articles: GardenArticle[]) =>
    set({
      articles,
  ...
  setArticleSearchQuery: (query: string) =>
    set((state: StudioState) => ({
  ...
  addInspirationDraft: (draft: InspirationDraft) =>
    set((state: StudioState) => ({
  ...
  setComplianceResult: (result: null | { passed: boolean; issues: unknown[] }) =>
