...
export function SharePanel({ blocks, imageUrls, getTextContent, activityLogText, notesText, onClose }: SharePanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" onClick={onClose}>
      ...
      <div className="relative bg-paper rounded-2xl shadow-2xl border border-paper-deep/20 w-[500px] max-h-[600px] flex flex-col" onClick={e => e.stopPropagation()}>
