    ...
    <div className="flex items-center gap-1 bg-paper-warm/60 rounded-xl p-1">
      <button
        ...
        className={`px-4 py-1.5 text-[13px] rounded-lg transition-colors cursor-pointer ${
          active === 'public' ? 'bg-paper text-ink-soft shadow-sm' : 'text-ink-ghost hover:text-ink-soft'
        }`}
      >
      ...
      <button
        ...
        className={`px-4 py-1.5 text-[13px] rounded-lg transition-colors cursor-pointer ${
          active === 'personal' ? 'bg-paper text-ink-soft shadow-sm' : 'text-ink-ghost hover:text-ink-soft'
        }`}
      >
